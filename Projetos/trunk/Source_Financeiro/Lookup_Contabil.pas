...
uses
  ...
  MensagemUtils, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
...
type
  ...
  TdtmLookupContabil = class(TDataModule)
    ...
    sqlTipoDespesaTodos: TI9Query;
    dtsTipoDespesaTodos: TDataSource;
    sqlTipoDespesaTodosDESCRICAO: TStringField;
    sqlTipoDespesaTodosTIPO_DESPESA_ID: TBCDField;
    sqlTipoDespesaAtivos: TI9Query;
...
begin
  ...
  begin
    ...
    sqlCompromissoReserva.ParamByName('LANCAMENTO_COMPROMISSO_ID').AsInteger := StrToInt(vpLancamentoCompId);
