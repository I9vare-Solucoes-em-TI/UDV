...
uses
  ...
  DbxDevartInterBase, cxBarEditItem, Vcl.ImgList, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
...
procedure TfrmAgendamento.cxOrcamentoClick(Sender: TObject);
begin
...
begin
  ...
  if sqlLivroAgendamentoPARCELA_INICIAL.AsInteger > 1 then
    sqlLivroAgendamentoCALC_OBSERVACAO.AsString := 'O Número da Parcela inicial é a '+ sqlLivroAgendamentoPARCELA_INICIAL.AsString;
end;
