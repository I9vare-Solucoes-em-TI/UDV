inherited frmCadRelatorioFinanceiro: TfrmCadRelatorioFinanceiro
  ...
  object sqlRelatorioAnalitico: TI9Query
    ...
    object sqlRelatorioAnaliticoORDEM_GRUPO: TBCDField
  ...
  object sqlItensGenericos: TI9Query
    Aggregates = <>
    Connection = dtmControles.DB
    SQL.Strings = (
    ...
    object sqlItensGenericosVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
  ...
  object sqlRelatorioSomatorioGrupo: TI9Query
    Aggregates = <>
    Connection = dtmControles.DB
    SQL.Strings = (
      'SELECT SUM(LC.VALOR) AS VALOR,'#13#10'        LC.OPERACAO,'#13#10'        CC' +
  ...
  object sqlRelatorioResumido: TI9Query
    Aggregates = <>
    Connection = dtmControles.DB
    SQL.Strings = (
      'SELECT SUM(LC.VALOR) AS VALOR,'#13#10'        LC.OPERACAO,'#13#10'        CC' +
    ...
    Left = 576
    Top = 286
    object sqlRelatorioResumidoVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
    ...
    object sqlRelatorioResumidoBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
