...
var
  ...
  begin
    ...
    begin
      Application.MessageBox(Pchar('Valor Inválido!!!'), 'Aviso', MB_OK + MB_DEFBUTTON1 + MB_ICONINFORMATION);
      edtValor.SetFocus;
      Abort;
    end;
...
begin
  ...
  if Application.MessageBox('Confirma Transferência do Valor nas Contas Informadas?',
