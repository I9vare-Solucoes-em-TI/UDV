...
uses
  ...
  DbxDevartInterBase, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf,
...
type
  TfrmCadastroRapidoContas = class(TfrmCadastroAuxSimplificado)
    ...
    ClientAncestralTIPO_DESPESA_ID: TBCDField;
...
begin
  ...
  sqlReservasAtivas.ParamByName('BALANCETE_GRUPO_ID').AsInteger := vgTabBalancete[tabBalancete.TabIndex];
