...
uses
  ...
  dxBarBuiltInMenu, DbxDevartInterBase, FireDAC.Stan.Intf, FireDAC.Stan.Option,
...
var
  ...
  begin
    ...
    VerificarPreenchimentoLCX_TX(lcxProvisaoOrigem.Text, 'Provisão Origem', lcxProvisaoOrigem);
    VerificarPreenchimentoLCX_TX(lcxProvisaoDestino.Text, 'Provisão Destino', lcxProvisaoDestino);
    ...
    begin
      Application.MessageBox(Pchar('Provisão de Origem não pode ser igual a Provisão de Destino!!!'), 'Aviso', MB_OK + MB_DEFBUTTON1 + MB_ICONINFORMATION);
