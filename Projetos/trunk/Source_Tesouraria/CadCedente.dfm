inherited frmCadCedente: TfrmCadCedente
  ...
  inherited DataSetAncestral: TI9Query
    SQL.Strings = ('SELECT * '#13#10'FROM T_CEDENTE'#13#10'ORDER BY DESCRICAO')
    Left = 691
    Top = 406
  end
  ...
  inherited ClientAncestral: TClientDataSet
    ...
    object ClientAncestralDB_TAXA: TBCDField
      FieldName = 'DB_TAXA'
      Precision = 20
      Size = 3
    end
    object ClientAncestralDB_MULTA: TBCDField
      FieldName = 'DB_MULTA'
      Precision = 20
      Size = 2
    end
    ...
    object ClientAncestralPRAZO_DIA: TBCDField
      FieldName = 'PRAZO_DIA'
      Precision = 20
      Size = 2
    end
    ...
    object ClientAncestralCONTABIL_CONTA_MULTA_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_MULTA_ID'
      Precision = 20
      Size = 2
    end
    object ClientAncestralCONTABIL_CONTA_TAXA_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_TAXA_ID'
      Precision = 20
      Size = 2
    end
    object ClientAncestralDIA_VENCIMENTO_PADRAO: TBCDField
    ...
    object ClientAncestralCONTABIL_CONTA_JUROS_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_JUROS_ID'
      Precision = 20
      Size = 2
    end
    object ClientAncestralDB_RESERVA_JUROS_ID: TBCDField
