...
begin
  ...
  begin
    ...
    sqlPlanoListagem.ParamByName('BALANCETE_GRUPO_ID').AsBCD := vgTabBalancete[tabBalancete.TabIndex];
...
begin
  ...
  ClientAncestral.AfterScroll := ClientAncestralAfterScroll;
  Application.MessageBox('GRUPO ATIVADO COMO GENÉRICO!!!', 'informação', MB_OK + MB_ICONINFORMATION);
end;
...
begin
  ...
  ClientAncestral.Refresh;
  ClientAncestral.AfterScroll := ClientAncestralAfterScroll;
  Application.MessageBox('GENÉRICO DO GRUPO DESATIVADO!!!', 'informação', MB_OK + MB_ICONINFORMATION);
end;
