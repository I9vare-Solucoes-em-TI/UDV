...
uses
  ...
  DbxDevartInterBase, cxRadioGroup, cxCheckComboBox, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
...
type
  TfrmGerenciadorCompromisso = class(TForm)
    ...
    sqlCompromissoLancado: TI9Query;
    ...
    sqlCompromissoMensalLANCAMENTO_COMPROMISSO_ID: TBCDField;
    ...
    sqlCompromissoMensalVALOR_ANTERIOR: TBCDField;
    ...
    N1: TMenuItem;
    sqlPessoasAtualiza: TI9Query;
    sqlPessoasAtualizaPESSOA_ID: TBCDField;
    ...
    sqlAssociadosVALOR_ATUAL: TBCDField;
    sqlAssociadosLANCAMENTO_COMPROMISSO_ID: TBCDField;
    sqlAssociadosNOME: TStringField;
    sqlAssociadosCOMPROMISSO_AGENDADO_ID: TBCDField;
    ...
    sqlCompromissoLancadoLANCAMENTO_COMPROMISSO_ID: TBCDField;
    ...
    sqlCompromissoLancadoVALOR_ATUAL: TBCDField;
    sqlCompromissoLancadoVALOR_ANTERIOR: TBCDField;
    sqlCompromissoLancadoANO_MES_FINAL: TStringField;
    sqlCompromissoLancadoCONTABIL_CONTA_ID: TBCDField;
    ...
    sqlCompromissoMensalCENTRO_CUSTO_ID: TBCDField;
    sqlCompromissoMensalCEDENTE_ID: TBCDField;
    sqlCompromissoMensalBALANCETE_GRUPO_ID: TBCDField;
    sqlCompromissoLancadoBALANCETE_GRUPO_ID: TBCDField;
    sqlCompromissoRealizadoBALANCETE_GRUPO_ID: TBCDField;
    sqlAssociadosBALANCETE_GRUPO_ID: TBCDField;
    sqlAssociadosCEDENTE_ID: TBCDField;
    ...
    sqlReservaCompromisso: TI9Query;
    dtsReservaCompromisso: TDataSource;
    sqlReservaCompromissoCONTABIL_RESERVA_ID: TBCDField;
    sqlReservaCompromissoCONTABIL_CONTA_ID: TBCDField;
    sqlReservaCompromissoPERCENTUAL: TBCDField;
    sqlReservaCompromissoRESERVA_ID: TBCDField;
    sqlReservaCompromissoLANCAMENTO_COMPROMISSO_ID: TBCDField;
    ...
    sqlReservaLancado: TI9Query;
    dtsReservaLancado: TDataSource;
    sqlReservaLancadoCONTABIL_RESERVA_ID: TBCDField;
    sqlReservaLancadoCONTABIL_CONTA_ID: TBCDField;
    sqlReservaLancadoPERCENTUAL: TBCDField;
    sqlReservaLancadoRESERVA_ID: TBCDField;
    sqlReservaLancadoLANCAMENTO_COMPROMISSO_ID: TBCDField;
    ...
    sqlTotalAssociadoVALOR: TBCDField;
    Panel7: TPanel;
...
begin
  ...
  begin
    ...
    begin
      ...
      if viTodos = 'S' then
      begin
        sqlPessoasAtualiza.SQL.Text := ' SELECT PESSOA_ID FROM T_PESSOA WHERE SITUACAO IN (''1'',''3'')'+
        ...
        if vpPessoas <> '' then
        begin
           sqlPessoasAtualiza.SQL.Text := ' SELECT PESSOA_ID FROM T_PESSOA '+
...
begin
  ...
  sqlCompromissoMensal.ParamByName('BALANCETE_GRUPO_ID').AsBCD := vgTabBalancete[fmeCompromisso1.tabBalancete.TabIndex];
  sqlCompromissoMensal.Open;
  sqlReservaCompromisso.Active := True;

  sqlAssociados.Close;
  sqlAssociados.ParamByName('CEDENTE_ID').AsBCD         := vgCedenteAtivo;
  sqlAssociados.ParamByName('BALANCETE_GRUPO_ID').AsBCD := vgTabBalancete[fmeCompromisso1.tabBalancete.TabIndex];
  sqlAssociados.Open;

  sqlCompromissoLancado.Close;
  sqlCompromissoLancado.ParamByName('CEDENTE_ID').AsBCD         := vgCedenteAtivo;
  sqlCompromissoLancado.ParamByName('BALANCETE_GRUPO_ID').AsBCD := vgTabBalancete[fmeCompromisso1.tabBalancete.TabIndex];
...
begin
  ...
  sqlTotalAssociado.SQL.Text := viSql;
...
begin
  ...
  sqlAssociados.ParamByName('CEDENTE_ID').AsBCD                 := vgCedenteAtivo;
  sqlAssociados.ParamByName('BALANCETE_GRUPO_ID').AsBCD         := vgTabBalancete[fmeCompromisso1.tabBalancete.TabIndex];
  sqlAssociados.ParamByName('LANCAMENTO_COMPROMISSO_ID').AsBCD  := sqlCompromissoMensalLANCAMENTO_COMPROMISSO_ID.AsCurrency;
  sqlAssociados.Open;
...
begin
  ...
  sqlAjusteProgramado.ParamByName('LANCAMENTO_COMPROMISSO_ID').AsBCD := sqlCompromissoMensalLANCAMENTO_COMPROMISSO_ID.AsInteger;
  if rdbAjusteMesAtual.Checked then
       sqlAjusteProgramado.ParamByName('ANOMES').AsBCD    := vgPeriodoAtual
  else sqlAjusteProgramado.ParamByName('ANOMES').AsString := dtmLookupContabil.InclementarAnoMes(vgPeriodoAtual.ToString);
