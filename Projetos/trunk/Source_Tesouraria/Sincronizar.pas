...
uses
  ...
  cxProgressBar, dxGDIPlusClasses, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
...
type
  ...
  TfrmSincronizar = class(TForm)
    ...
    sqlVerificar: TI9Query;
    sqlVerificarNOME: TStringField;
    sqlVerificarPESSOA_ID: TBCDField;
    ...
    sqlVerificarSINCRONIZA_REUNI_ID: TBCDField;
    ...
    sqlVerificarCEDENTE_ID: TBCDField;
    ...
    sqlVerificarPESSOA_GRUPO_ID: TBCDField;
    Panel4: TPanel;
    ...
    sqlVerificarPESSOA_TERCEIRO_ID: TBCDField;
...
var
  ...
  begin
    sqlVerificar.Active := False;
    sqlVerificar.ParamByName('CEDENTE_ID').AsBCD := vgCedenteAtivo;
...
begin
  ...
  begin
    ...
    sqlSincronizacaoAnterior.Active := False;
    sqlSincronizacaoAnterior.ParamByName('CEDENTE_ID').AsCurrency          := vgCedenteAtivo;
    sqlSincronizacaoAnterior.ParamByName('SINCRONIZA_REUNI_ID').AsCurrency := dtmControles.SimpleAuxiliar.FieldByName('SINCRONIZA').AsInteger;
