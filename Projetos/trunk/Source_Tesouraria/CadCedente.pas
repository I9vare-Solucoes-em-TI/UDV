...
type
  TfrmCadCedente = class(TfrmCadBasico)
    ...
    ClientAncestralDB_TAXA: TBCDField;
    ClientAncestralDB_MULTA: TBCDField;
    Panel1: TPanel;
    Bevel1: TBevel;
    cxLabel8: TcxLabel;
    cxLabel9: TcxLabel;
    ...
    ClientAncestralPRAZO_DIA: TBCDField;
    cxLabel2: TcxLabel;
    ...
    ClientAncestralCONTABIL_CONTA_MULTA_ID: TBCDField;
    ClientAncestralCONTABIL_CONTA_TAXA_ID: TBCDField;
    ClientAncestralDIA_VENCIMENTO_PADRAO: TBCDField;
    ...
    ClientAncestralCONTABIL_CONTA_JUROS_ID: TBCDField;
    cxLabel20: TcxLabel;
    lcxReservaId: TcxDBLookupComboBox;
    ClientAncestralDB_RESERVA_JUROS_ID: TBCDField;
