...
uses
  ...
  cxNavigator, dxBarBuiltInMenu, DbxDevartInterBase, FireDAC.Stan.Intf,
...
type
  TfrmPessoaPesquisa = class(TForm)
    ...
    sqlCompromissoAgendadoRESERVA_ID: TBCDField;
