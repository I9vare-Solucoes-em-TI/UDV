object frmGerenciadorCompromisso: TfrmGerenciadorCompromisso
  ...
  object sqlCompromissoLancado: TI9Query
    ...
    object sqlCompromissoLancadoLANCAMENTO_COMPROMISSO_ID: TBCDField
    ...
    object sqlCompromissoLancadoVALOR_ATUAL: TBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
    object sqlCompromissoLancadoVALOR_ANTERIOR: TBCDField
    ...
    object sqlCompromissoLancadoCONTABIL_CONTA_ID: TBCDField
    ...
    object sqlCompromissoLancadoBALANCETE_GRUPO_ID: TBCDField
  ...
  object sqlCompromissoMensal: TI9Query
    ...
    object sqlCompromissoMensalLANCAMENTO_COMPROMISSO_ID: TBCDField
      FieldName = 'LANCAMENTO_COMPROMISSO_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlCompromissoMensalVALOR_ATUAL: TBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
    object sqlCompromissoMensalVALOR_ANTERIOR: TBCDField
      FieldName = 'VALOR_ANTERIOR'
      Precision = 20
      Size = 3
    end
    ...
    object sqlCompromissoMensalCONTABIL_CONTA_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlCompromissoMensalCENTRO_CUSTO_ID: TBCDField
      FieldName = 'CENTRO_CUSTO_ID'
      Precision = 20
      Size = 2
    end
    object sqlCompromissoMensalCEDENTE_ID: TBCDField
      FieldName = 'CEDENTE_ID'
      Precision = 20
      Size = 2
    end
    object sqlCompromissoMensalBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlPessoasAtualiza: TI9Query
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'SELECT PESSOA_ID'#13#10'FROM T_PESSOA')
    Left = 580
    Top = 428
    object sqlPessoasAtualizaPESSOA_ID: TBCDField
      FieldName = 'PESSOA_ID'
      Precision = 20
      Size = 2
    end
  end
  object sqlAssociados: TI9Query
    ...
    object sqlAssociadosPESSOA_ID: TBCDField
      FieldName = 'PESSOA_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlAssociadosVALOR_ATUAL: TBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
    object sqlAssociadosLANCAMENTO_COMPROMISSO_ID: TBCDField
      FieldName = 'LANCAMENTO_COMPROMISSO_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlAssociadosCOMPROMISSO_AGENDADO_ID: TBCDField
      FieldName = 'COMPROMISSO_AGENDADO_ID'
      Precision = 20
      Size = 2
    end
    object sqlAssociadosBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
    object sqlAssociadosCEDENTE_ID: TBCDField
      FieldName = 'CEDENTE_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlReservaCompromisso: TI9Query
    ...
    object sqlReservaCompromissoCONTABIL_RESERVA_ID: TBCDField
      FieldName = 'CONTABIL_RESERVA_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlReservaCompromissoCONTABIL_CONTA_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    object sqlReservaCompromissoPERCENTUAL: TBCDField
      FieldName = 'PERCENTUAL'
      Precision = 20
      Size = 2
    end
    object sqlReservaCompromissoRESERVA_ID: TBCDField
      FieldName = 'RESERVA_ID'
      Precision = 20
      Size = 2
    end
    object sqlReservaCompromissoLANCAMENTO_COMPROMISSO_ID: TBCDField
      FieldName = 'LANCAMENTO_COMPROMISSO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlReservaLancado: TI9Query
    AfterScroll = sqlReservaCompromissoAfterScroll
    IndexFieldNames = 'LANCAMENTO_COMPROMISSO_ID'
    ...
    object sqlReservaLancadoCONTABIL_RESERVA_ID: TBCDField
      FieldName = 'CONTABIL_RESERVA_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlReservaLancadoCONTABIL_CONTA_ID: TBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    object sqlReservaLancadoPERCENTUAL: TBCDField
      FieldName = 'PERCENTUAL'
      Precision = 20
      Size = 2
    end
    object sqlReservaLancadoRESERVA_ID: TBCDField
      FieldName = 'RESERVA_ID'
      Precision = 20
      Size = 2
    end
    object sqlReservaLancadoLANCAMENTO_COMPROMISSO_ID: TBCDField
      FieldName = 'LANCAMENTO_COMPROMISSO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlTotalAssociado: TI9Query
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
    ...
    object sqlTotalAssociadoVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
