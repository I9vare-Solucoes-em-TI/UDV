...
type
  ...
  TfrmGerenciadorSaidas = class(TForm)
    ...
    sqlCompromissoRealizadoSAIDA_NUMERO: TBCDField;
    ...
    sqlCompromissoRealizadoCENTRO_CUSTO_ID: TBCDField;
    ...
    sqlCompromissoRealizadoCOMPROMISSO_DETALHADO_ID: TBCDField;
...
var
  ...
  procedure RegistrarCompromisso(vpClientRegistrar : TClientDataSet;
    ...
    procedure RegistrarItensParcial(vpClientRegistrar : TI9Query);
    begin
      with dtmControles.sqlAuxiliar do
      begin
        ParamByName('CONTABIL_CONTA_ID').AsBCD      := vpClientRegistrar.FieldByName('Contabil_Conta_Id').AsInteger;
