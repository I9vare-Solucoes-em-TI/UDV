...
uses
  ...
  dxBarBuiltInMenu, frxClass, DbxDevartInterBase, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
...
type
  TfrmMovimentacao = class(TForm)
    ...
    sqlPesquisa1LANCAMENTO_COMPROMISSO_ID: TBCDField;
    sqlPesquisa1COMPROMISSO_VENCIDO_ID: TBCDField;
    sqlPesquisa1PESSOA_ID: TBCDField;
    sqlPesquisa1VALOR_ATUAL: TBCDField;
    sqlPesquisa1BOLETA_ID: TBCDField;
    sqlPesquisa1DIFERENCA: TStringField;
    sqlPesquisa1VALOR_ORIGEM: TBCDField;
    sqlPesquisa1QTD_ADICIONAL: TBCDField;
    sqlPesquisa1ATUALIZADO: TStringField;
    sqlPesquisa1DATA_REALIZACAO: TSQLTimeStampField;
    sqlPesquisa1BALANCETE_GRUPO_ID: TBCDField;
    sqlPesquisa1ANO_MES_REFERENCIA: TStringField;
    sqlPesquisa1PESSOA_NOME: TStringField;
    sqlPesquisa1SAIDA_NUMERO: TBCDField;
    sqlPesquisa1SAIDA_TIPO: TStringField;
    sqlPesquisa1DESCRICAO: TStringField;
    sqlPesquisa1CENTRO_CUSTO_ID: TBCDField;
    ...
    sqlPesquisa1RECIBO_NUMERO: TBCDField;
    sqlPesquisa1SAIDA_PESSOA_ID: TBCDField;
    ...
    sqlPesquisaDetalhada: TI9Query;
    dtsPesquisaDetalhada: TDataSource;
    sqlPesquisaDetalhadaCONTABIL_CONTA_ID: TBCDField;
    sqlPesquisaDetalhadaCENTRO_CUSTO_ID: TBCDField;
    sqlPesquisaDetalhadaBALANCETE_GRUPO_ID: TBCDField;
    sqlPesquisaDetalhadaVALOR_ATUAL: TBCDField;
    ...
    sqlPesquisaPendenciaSoma: TI9Query;
    dtsPesquisaPendenciaSoma: TDataSource;
    sqlPesquisaPendenciaSomaVALOR_TOTAL: TBCDField;
    ...
    ClientPesquisaDetalhadaCONTABIL_CONTA_ID: TBCDField;
    ClientPesquisaDetalhadaCENTRO_CUSTO_ID: TBCDField;
    ClientPesquisaDetalhadaBALANCETE_GRUPO_ID: TBCDField;
    ClientPesquisaDetalhadaVALOR_ATUAL: TBCDField;
    ...
    sqlPesquisa1CONTABIL_CONTA_ID: TBCDField;
...
var
  ...
  begin
    ...
    begin
      ...
      sqlPesquisaDetalhada.Active := False;
      sqlPesquisaDetalhada.SQL.Text := viSqlExecutar;
...
{    if viCompromissosEncontrado = '' then
  ...
  begin
    ...
    sqlPesquisaQuitado.Active := False;
    sqlPesquisaQuitado.SQL.Text := viSql;
  ...
  begin
    ...
    begin
      ...
      sqlPesquisaDetalhada.Active := False;
      sqlPesquisaDetalhada.SQL.Text := viSql;
      sqlPesquisaDetalhada.Active := True;
      PreencherCompromissosDetalhados;
    end;
  end;
...
begin
  ...
  sqlPesquisaPendenciaSoma.Active := False;
  sqlPesquisaPendenciaSoma.SQL.Text := viSql2;
...
begin
  ...
  sqlPesquisa1.SQL.Text := viSql + viCondicao + ' ORDER BY CV.DATA_REALIZACAO DESC, CV.ANO_MES_REFERENCIA, CV.CONTABIL_CONTA_ID ';
