inherited frmCadGrupoFamiliar: TfrmCadGrupoFamiliar
  ...
  inherited DataSetAncestral: TI9Query
    SQL.Strings = ('SELECT *'#13#10'FROM T_PESSOA_GRUPO'#13#10'ORDER BY DESCRICAO')
    Left = 443
    Top = 262
  end
  ...
  inherited ClientAncestral: TClientDataSet
    ...
    Left = 506
    Top = 262
    object ClientAncestralPESSOA_GRUPO_ID: TBCDField
  ...
  object sqlAssociados: TI9Query
    ...
    object sqlAssociadosPESSOA_GRUPO_ID: TBCDField
      FieldName = 'PESSOA_GRUPO_ID'
      Precision = 20
      Size = 2
    end
