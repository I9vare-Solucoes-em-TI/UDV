object frmControleBalancete: TfrmControleBalancete
  ...
  object sqlBalanceteAnterior: TI9Query
    Aggregates = <>
    SQL.Strings = ('SELECT *'#13#10'FROM T_BALANCETE'#13#10'WHERE BALANCETE_ID = :BALANCETE_ID')
    ParamData = <
      item
        DataType = ftBCD
        Name = 'BALANCETE_ID'
    ...
    Left = 20
    Top = 244
    object sqlBalanceteAnteriorBALANCETE_ID: TBCDField
    ...
    object sqlBalanceteAnteriorSALDO_CONTA: TBCDField
      FieldName = 'SALDO_CONTA'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAnteriorSALDO_APLICACAO: TBCDField
      FieldName = 'SALDO_APLICACAO'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAnteriorSALDO_CAIXA: TBCDField
      FieldName = 'SALDO_CAIXA'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAnteriorSALDO_NAO_COMPENSADO: TBCDField
    ...
    object sqlBalanceteAnteriorCEDENTE_ID: TBCDField
  ...
  object sqlBalanceteAtual: TI9Query
    Aggregates = <>
    SQL.Strings = ('SELECT *'#13#10'FROM T_BALANCETE'#13#10'WHERE BALANCETE_ID = :BALANCETE_ID')
    ParamData = <
      item
    ...
    Left = 84
    Top = 244
    object sqlBalanceteAtualBALANCETE_ID: TBCDField
      FieldName = 'BALANCETE_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlBalanceteAtualSALDO_CONTA: TBCDField
      FieldName = 'SALDO_CONTA'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAtualSALDO_APLICACAO: TBCDField
      FieldName = 'SALDO_APLICACAO'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAtualSALDO_CAIXA: TBCDField
      FieldName = 'SALDO_CAIXA'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteAtualSALDO_NAO_COMPENSADO: TBCDField
      FieldName = 'SALDO_NAO_COMPENSADO'
      Precision = 20
      Size = 3
    end
    ...
    object sqlBalanceteAtualCEDENTE_ID: TBCDField
      FieldName = 'CEDENTE_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlBalanceteHistorico: TI9Query
    Aggregates = <>
    SQL.Strings = (
    ...
    Left = 52
    Top = 244
    object sqlBalanceteHistoricoBALANCETE_HISTORICO_ID: TBCDField
      FieldName = 'BALANCETE_HISTORICO_ID'
      Precision = 20
      Size = 2
    end
    object sqlBalanceteHistoricoBALANCETE_ID: TBCDField
      FieldName = 'BALANCETE_ID'
      Precision = 20
      Size = 2
    end
    object sqlBalanceteHistoricoBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
    object sqlBalanceteHistoricoENTRADAS: TBCDField
      FieldName = 'ENTRADAS'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteHistoricoSAIDAS: TBCDField
      FieldName = 'SAIDAS'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteHistoricoSALDO_FINAL: TBCDField
      FieldName = 'SALDO_FINAL'
      Precision = 20
      Size = 3
    end
    object sqlBalanceteHistoricoSALDO_ANTERIOR: TBCDField
  ...
  object sqDadosBalanceteLeitura: TI9Query
    Aggregates = <>
    ...
    Left = 92
    Top = 344
    object sqDadosBalanceteLeituraVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
  ...
  object sqlDadosGenericos: TI9Query
    Aggregates = <>
    Connection = dtmControles.DB
    SQL.Strings = (
    ...
    Left = 128
    Top = 344
    object sqlDadosGenericosVALOR_ATUAL: TBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
  ...
  object sqDadosBalanceteContador: TI9Query
    Aggregates = <>
    SQL.Strings = (
      'SELECT SUM(CV.VALOR_ATUAL) AS VALOR, CV.TIPO_OPERACAO,'#13#10'       C' +
    ...
    Left = 164
    Top = 344
    object sqDadosBalanceteContadorVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
  ...
  object sqlBalanceteDetalhado: TI9Query
    Aggregates = <>
    Connection = dtmControles.DB
    SQL.Strings = (
    ...
    object sqlBalanceteDetalhadoVALOR_ATUAL: TBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
    ...
    object sqlBalanceteDetalhadoRECIBO_NUMERO: TBCDField
      FieldName = 'RECIBO_NUMERO'
      Precision = 20
      Size = 2
    end
    object sqlBalanceteDetalhadoBOLETA_ID: TBCDField
      FieldName = 'BOLETA_ID'
      Precision = 20
      Size = 2
    end
    object sqlBalanceteDetalhadoSAIDA_NUMERO: TBCDField
  ...
  object sqlDadosBalanceteAnual: TI9Query
    Aggregates = <>
    SQL.Strings = (
      'SELECT SUM(CV.VALOR_ATUAL) AS VALOR, CV.TIPO_OPERACAO,'#13#10'       C' +
      'C.DESCRICAO AS PLANO_CONTAS, CC.GRUPO AS GRUPO_DESCRICAO,'#13#10'     ' +
  ...
  object sqlDadosBalanceteGeral: TI9Query
    Aggregates = <>
    SQL.Strings = (
      'SELECT SUM(CV.VALOR_ATUAL) AS VALOR, CV.TIPO_OPERACAO,'#13#10'       C' +
      'C.DESCRICAO AS PLANO_CONTAS, CC.GRUPO AS GRUPO_DESCRICAO,'#13#10'     ' +
    ...
    Left = 268
    Top = 344
    object sqlDadosBalanceteGeralVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
    ...
    object sqlDadosBalanceteGeralBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
