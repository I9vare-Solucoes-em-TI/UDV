...
type
  ...
  TfrmSelecionarBoletoEnviar = class(TForm)
    ...
    sqlBoletosBOLETA_ID: TBCDField;
    sqlBoletosVALOR: TBCDField;
    sqlBoletosPESSOA_ID: TBCDField;
    sqlBoletosPESSOA_GRUPO_ID: TBCDField;
...
begin
  ...
  sqlBoletos.Active := False;
  sqlBoletos.ParamByName('CEDENTE_ID').AsInteger     := vgCedenteAtivo;
  sqlBoletos.ParamByName('ANO_MES_BOLETO').AsString  := vgPeriodoAtual.ToString;
  sqlBoletos.ParamByName('EMAIL').AsString           := vgBoleto.EnviarEmail;
