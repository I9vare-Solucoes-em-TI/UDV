 ...
 * @version    1.0.0.0
 * @unit       Geral.Model.Entity.Impl.PKI.XSignPKCS.pas
 * @author     I9vare
...
constructor TSubject.Create(const vpXSignPKCS: _XSignPKCS);
begin
  inherited Create;
  FXSignPKCS := vpXSignPKCS;
...
class function TSubject.New(const vpXSignPKCS: _XSignPKCS): IX500Principal;
begin
  Result := Create(
    vpXSignPKCS);
end;
