object dtmLookup: TdtmLookup
  ...
  object sqlCedenteTodos: TI9Query
    Aggregates = <>
    SQL.Strings = (
    ...
    object sqlCedenteTodosCEDENTE_ID: TBCDField
  ...
  object sqlCedenteAtivos: TI9Query
    Aggregates = <>
    SQL.Strings = (
    ...
    object sqlCedenteAtivosCEDENTE_ID: TBCDField
      FieldName = 'CEDENTE_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlPessoas: TI9Query
    ...
    object sqlPessoasPESSOA_ID: TBCDField
      FieldName = 'PESSOA_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlGrupoTodos: TI9Query
    ...
    object sqlGrupoTodosPESSOA_GRUPO_ID: TBCDField
      FieldName = 'PESSOA_GRUPO_ID'
      Precision = 20
      Size = 2
    end
  end
  object sqlGrupoAtivo: TI9Query
    Aggregates = <>
    SQL.Strings = (
      'SELECT DESCRICAO, PESSOA_GRUPO_ID'#13#10'FROM T_PESSOA_GRUPO'#13#10'WHERE CE' +
  ...
  object sqlCabecalho: TI9Query
    ...
    SQL.Strings = (
      ...
      'ERE BALANCETE_GRUPO_ID = :BALANCETE_GRUPO_ID'#13#10'     AND CEDENTE_I' +
      'D = :CEDENTE_ID')
    ParamData = <
      item
        DataType = ftBCD
  ...
  object sqlReservasAtivas: TI9Query
    ...
    object sqlReservasAtivasBALANCETE_GRUPO_ID: TBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
