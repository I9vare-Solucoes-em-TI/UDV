object frmSeloSelecao: TfrmSeloSelecao
  Left = 0
  Top = 0
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSizeToolWin
  Caption = 'Sele'#231#227'o de Selo'
  ClientHeight = 344
  ClientWidth = 749
  Color = clBtnFace
  ...
  object dtsSeloItens: TDataSource
    DataSet = sqlSeloItens
    Left = 20
    Top = 143
  end
  object sqlSeloItens: TI9Query
    ...
    object sqlSeloItensNUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 15
    end
  end
