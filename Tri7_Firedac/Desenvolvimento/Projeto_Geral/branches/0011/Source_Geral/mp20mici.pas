...
================================================================================
*******************************************************************************}
procedure TfrmBematech.Button1Click(Sender: TObject);
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.Button2Click(Sender: TObject);
var Contador   : integer;
    InputString: string;
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.ComboBox1Change(Sender: TObject);
var
  ret  : integer;
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.Button5Click(Sender: TObject);
begin
  retorno:=FechaPorta();
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnCaracterGraficoClick(Sender: TObject);
{
                  DESENHO
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.Button9Click(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnStatusPortaClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnCortarPapelClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnAguardaImpressaoTextoClick(Sender: TObject);
var Contador   : integer;
    InputString: string;
begin
  if RBIdioma.Checked then
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.ComboModeloImpressoraChange(Sender: TObject);
...
procedure TfrmBematech.Inicializa(Sender: TObject);
begin
  // driver
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnTesteTextoFormatadoClick(Sender: TObject);
var Fonte : string;
var Texto : string;
   begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.BtnImprimirTextoClick(Sender: TObject);
begin
   RichEdit1.Print( '' );
end;
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.FindfileClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.Button4Click(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnPrgramarExtratoClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnHabilitaTamanhoExtratoClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnPrgramarPresenterClick(Sender: TObject);
begin
...
================================================================================
*******************************************************************************}
procedure TfrmBematech.btnHabilitaPresenterClick(Sender: TObject);
begin
...
procedure TfrmBematech.RBIdiomaClick(Sender: TObject);
begin
  Traduz_Caption(true);
  frmBematech.imgIcones.GetIcon(0, frmBematech.icon);
end;

procedure TfrmBematech.RadioButton2Click(Sender: TObject);
begin
  Traduz_Caption(false);
  frmBematech.imgIcones.GetIcon(1, frmBematech.icon);
end;

procedure TfrmBematech.BtnFonteClick(Sender: TObject);
begin
...
procedure TfrmBematech.CBImpressorasChange(Sender: TObject);
begin
...
Procedure TfrmBematech.HabilitaFuncoesExtrato(Flag: boolean);
begin
  with frmBematech do
  begin
...
Procedure TfrmBematech.HabilitaProgramacaoPresenter(Flag: boolean);
begin
  with frmBematech do
  begin
...
procedure TfrmBematech.btnAutenticacaoClick(Sender: TObject);
begin
...
procedure TfrmBematech.btnVerificaDocInseridoClick(Sender: TObject);
begin
...
procedure TfrmBematech.btnVerificarPapelPresenterClick(Sender: TObject);
begin
...
procedure TfrmBematech.FormCreate(Sender: TObject);
begin
...
procedure TfrmBematech.PageControl1Change(Sender: TObject);
begin
...
procedure TfrmBematech.BtnCorteParcialClick(Sender: TObject);
begin
...
procedure TfrmBematech.CBSelectCodigoChange(Sender: TObject);
begin
  MedCodigo.Text := '';
...
procedure TfrmBematech.RBFinaClick(Sender: TObject);
begin
  CBSelectCodigo.onchange(self);
end;

procedure TfrmBematech.RBMediaClick(Sender: TObject);
begin
  CBSelectCodigo.onchange(self);
end;

procedure TfrmBematech.RbGrossaClick(Sender: TObject);
begin
  CBSelectCodigo.onchange(self);
end;

procedure TfrmBematech.BtnImprimirCodigoClick(Sender: TObject);
...
procedure TfrmBematech.findFileBtnClick(Sender: TObject);
var
  temp : string;
...
procedure TfrmBematech.TabSheet3Show(Sender: TObject);
begin
...
procedure TfrmBematech.HeighEditKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmBematech.PrintNormalClick(Sender: TObject);
var
  mode : integer;
  msg  : string;
begin
...
procedure TfrmBematech.ComboBoxBitolaChange(Sender: TObject);
var
  bitola : integer;
begin
  bitola := 48;
...
procedure TfrmBematech.ComboBoxAlgoChange(Sender: TObject);
begin
//  ret := SelectDithering(ComboBoxAlgo.ItemIndex);
end;

procedure TfrmBematech.PrintSpecialBtnClick(Sender: TObject);
var
  bmpheight, bmpWidth, rotate : integer;
begin
  ...
  if CheckBoxFitOnPage.Checked then begin
    bmpheight := -1;
    bmpWidth := -1;
  end;
...
procedure TfrmBematech.CheckBoxFitOnPageClick(Sender: TObject);
begin
