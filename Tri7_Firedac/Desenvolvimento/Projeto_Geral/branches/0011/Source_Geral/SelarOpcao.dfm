object frmSelarOpcao: TfrmSelarOpcao
  Left = 0
  Top = 0
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsSizeToolWin
  Caption = 'Selar Documento'
  ClientHeight = 181
  ClientWidth = 337
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cxLabel8: TcxLabel
      ...
      Top = 4
      Align = alTop
      Caption = '>> Selecione o Local da Selagem'
      ParentFont = False
    ...
    object rdbSelarFinal: TcxRadioButton
      Left = 24
      Top = 48
      Width = 145
      Height = 17
      Caption = 'Selar Final do Documento'
      Checked = True
      TabOrder = 1
      TabStop = True
    end
    object rdbSelarSelecionado: TcxRadioButton
      Left = 175
      Top = 48
      Width = 148
      Height = 17
      Caption = 'Selar no Local Selecionado'
      TabOrder = 2
    end
