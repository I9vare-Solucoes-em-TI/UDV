...
uses
  ...
  cxTextEdit, cxGroupBox, cxDBEdit, cxContainer, cxLabel, SimpleDS, cxGraphics,
  cxLookAndFeels, cxLookAndFeelPainters, Menus, dxSkinsCore, FMTBcd, cxControls,
  ...
  cxLookupEdit, cxDBLookupEdit, Provider, ActnList, ComCtrls, StdCtrls, ExtCtrls,
  DbxDevartInterBase, System.Actions, FireDAC.Stan.Intf, FireDAC.Stan.Option,
...
uses Controles, AtoMostrarTextoLavrado;
...
begin
  ...
  begin
    ...
    if ClientAncestralTB_ANDAMENTOSERVICO_ID.AsString <> '' then
    begin
...
begin
  ...
  TfrmTextoLavrado.MostraTextoLavrado;
