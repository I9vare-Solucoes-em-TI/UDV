...
Type
  ...
  TfrmOrdemServicoSolicitar = class(TForm)
    ...
    sqlSaldoOSCALC_REGISTRADO: TBooleanField;
    ...
    procedure chxOsPendentesClick(Sender: TObject);
...
var
  ...
  begin
    ExecutaSqlAuxiliar(' UPDATE C_ORDEM_SERVICO SET SITUACAO = '+QuotedStr('F')+','+
                       '    AND DATA_FECHAMENTO = :DATA_FECHAMENTO '+
...
procedure TfrmOrdemServicoSolicitar.chxOsPendentesClick(Sender: TObject);
begin
  sqlSaldoOS.Filtered := False;
  sqlSaldoOS.Filtered := True;
end;
...
procedure TfrmOrdemServicoSolicitar.sqlSaldoOSCalcFields(DataSet: TDataSet);
  ...
  function VerificarItensRI(vpIds : String):Boolean;
  var
    viIVerificar, viResultado : String;
  ...
  begin
    ...
    repeat
      viIVerificar      := RetornarValorListaString(vpIds,',');
...
begin
  ...
  sqlSaldoOSCALC_REGISTRADO.AsBoolean := VerificarItensRI(sqlSaldoOSIDS_RI.AsString);
end;
