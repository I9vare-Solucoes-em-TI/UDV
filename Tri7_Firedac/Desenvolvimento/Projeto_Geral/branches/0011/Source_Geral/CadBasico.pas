...
uses
  ...
  Dialogs, ActnList, ComCtrls, ExtCtrls, StdCtrls, cxButtons, DB,
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, DBClient, dxSkinGlassOceans;
...
type
  ...
  TfrmCadBasico = class(TForm)
    ...
    procedure SourceAncestralStateChange(Sender: TObject);
  private
    Status: string;
    ErroPost :  Boolean;
...
procedure TfrmCadBasico.SourceAncestralStateChange(Sender: TObject);
begin
  SetState(ClientAncestral.State);
end;
