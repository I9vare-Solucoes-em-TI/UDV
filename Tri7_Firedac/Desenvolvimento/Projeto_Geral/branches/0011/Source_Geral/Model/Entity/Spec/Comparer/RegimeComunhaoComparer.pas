...
type
  TRegimeComunhaoComparer = class(TComparer<IRegimeComunhao>,
    IComparer<IRegimeComunhao>)
  private
  ...
  public
    ...
    function Compare(
      const Left: IRegimeComunhao;
      const Right: IRegimeComunhao): Integer; override;
  end;
...
{ TRegimeComunhaoComparer }

function TRegimeComunhaoComparer.Compare(
  const Left: IRegimeComunhao;
  const Right: IRegimeComunhao): Integer;
{$REGION 'Variáveis'}
var
...
constructor TRegimeComunhaoComparer.Create(
