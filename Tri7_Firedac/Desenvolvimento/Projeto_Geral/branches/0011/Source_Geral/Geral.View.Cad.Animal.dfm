object frmAnimal: TfrmAnimal
  ...
  object pnlPrincipal: TPanel
    ...
    object grbDadosPET: TcxGroupBox
      ...
      object edtNomePET: TcxDBTextEdit
        ...
        DataBinding.DataSource = dtsG_ANIMAL
        ParentFont = False
      ...
      object btnCapturaFoto: TcxButton
        Left = 724
        Top = 151
        Width = 32
        Height = 25
      ...
      object btnCarregarArq: TcxButton
        Left = 724
        Top = 180
        Width = 32
        Height = 25
    ...
    object grbProprietarioGuardiao: TcxGroupBox
      Left = 2
      Top = 241
      Align = alClient
      Caption = 'Propriet'#225'rio/Guardi'#227'o'
      Ctl3D = True
      ParentCtl3D = False
      ParentFont = False
      Style.BorderStyle = ebsNone
      ...
      object pnlRight: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 0
        object btnAdicionarGuardiao: TcxButton
          Left = 5
          Top = 0
          Width = 32
          Height = 25
          ...
          Font.Style = []
          ParentFont = False
          OnClick = btnAdicionarGuardiaoClick
        end
        object btnExcluirGuardiao: TcxButton
          Left = 5
          Top = 29
          Width = 32
          Height = 25
          ...
          Font.Style = []
          ParentFont = False
          OnClick = btnExcluirGuardiaoClick
        end
      end
      object gridGuarda: TcxGrid
        Left = 2
        Top = 18
        Width = 717
        Height = 194
        ...
        BevelInner = bvLowered
        TabOrder = 1
        object tvGuarda: TcxGridDBTableView
          ...
          DataController.DataSource = dtsG_GUARDIAO
          ...
          object tvGuardaNOME: TcxGridDBColumn
            Caption = 'Nome'
          ...
          object tvGuardaCPF: TcxGridDBColumn
            Caption = 'Cpf'
          ...
          object tvGuardaTELEFONE: TcxGridDBColumn
            Caption = 'Telefone'
            DataBinding.FieldName = 'CALC_TELEFONE'
            Options.Editing = False
            Options.Filtering = False
            Options.FilteringAddValueItems = False
            Options.FilteringFilteredItemsList = False
  ...
  object PnlInformacao: TPanel
    ...
    object lblInformacao: TcxLabel
      ...
      Align = alClient
      AutoSize = False
      Caption = ' Registro de Guarda de Animais Dom'#233'sticos'
      ParentColor = False
      ParentFont = False
      ParentShowHint = False
      ShowHint = True
  ...
  object sqlG_ANIMAL: TI9Query
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'SELECT * FROM G_ANIMAL '#13#10'WHERE ANIMAL_ID = :ANIMAL_ID')
    Left = 80
    Top = 336
    ParamData = <
      item
    ...
    object sqlG_ANIMALANIMAL_ID: TBCDField
      FieldName = 'ANIMAL_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlG_ANIMALNOME: TStringField
      FieldName = 'NOME'
      Size = 60
    end
    object sqlG_ANIMALSEXO: TStringField
      FieldName = 'SEXO'
      Size = 1
    end
    object sqlG_ANIMALRACA: TStringField
      FieldName = 'RACA'
      Size = 60
    end
    object sqlG_ANIMALSISTEMA_ID: TBCDField
      FieldName = 'SISTEMA_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_ANIMALDATA_NASCIMENTO: TSQLTimeStampField
      FieldName = 'DATA_NASCIMENTO'
    end
    object sqlG_ANIMALOBSERVACAO: TStringField
      FieldName = 'OBSERVACAO'
      Size = 260
    end
    object sqlG_ANIMALPELE: TStringField
      FieldName = 'PELE'
      Size = 60
    end
    object sqlG_ANIMALREGISTRO_ID: TBCDField
      FieldName = 'REGISTRO_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_ANIMALESPECIE_ID: TBCDField
      FieldName = 'ESPECIE_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_ANIMALCOR: TStringField
      FieldName = 'COR'
      Size = 30
    end
  end
  object dtsG_ANIMAL: TDataSource
    DataSet = sqlG_ANIMAL
    Left = 80
    Top = 384
  end
  object sqlG_GUARDIAO: TI9Query
    OnCalcFields = sqlG_GUARDIAOCalcFields
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
    ...
    object sqlG_GUARDIAOGUARDIAO_ID: TBCDField
      FieldName = 'GUARDIAO_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlG_GUARDIAOSISTEMA_ID: TBCDField
      FieldName = 'SISTEMA_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_GUARDIAONOME: TStringField
      FieldName = 'NOME'
      Size = 60
    end
    object sqlG_GUARDIAOCPF: TStringField
      FieldName = 'CPF'
      Size = 15
    end
    object sqlG_GUARDIAOANIMAL_ID: TBCDField
      FieldName = 'ANIMAL_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_GUARDIAOTELEFONE: TStringField
      FieldName = 'TELEFONE'
      Size = 15
    end
    object sqlG_GUARDIAOREGISTRO_ID: TBCDField
      FieldName = 'REGISTRO_ID'
      Precision = 20
      Size = 2
    end
    object sqlG_GUARDIAOCALC_TELEFONE: TStringField
      FieldKind = fkCalculated
      FieldName = 'CALC_TELEFONE'
      Calculated = True
    end
  end
  object dtsG_GUARDIAO: TDataSource
    DataSet = sqlG_GUARDIAO
    Left = 184
    Top = 384
  end
