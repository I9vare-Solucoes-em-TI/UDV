object frmPalavraGramatical: TfrmPalavraGramatical
  Left = 287
  Top = 333
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsDialog
  Caption = 'Inser'#231#227'o R'#225'pida de Palavra Gramatical'
  ClientHeight = 138
  ClientWidth = 653
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtPalavra: TcxDBTextEdit
      ...
      DataBinding.DataSource = dtsPalavraGramatical
      Enabled = False
      ParentFont = False
  ...
  object sqlGramatica: TI9Query
    ...
    SQL.Strings = (
      'SELECT *'#13#10'FROM G_GRAMATICA'#13#10'ORDER BY GRAMATICA_ID')
    Left = 264
    Top = 96
    ...
    object sqlGramaticaPALAVRA: TStringField
      FieldName = 'PALAVRA'
      Size = 30
    end
    object sqlGramaticaPREFIXO: TStringField
      FieldName = 'PREFIXO'
      Size = 30
    end
    object sqlGramaticaSUFIXO_MS: TStringField
      FieldName = 'SUFIXO_MS'
      Size = 10
    end
    object sqlGramaticaSUFIXO_MP: TStringField
      FieldName = 'SUFIXO_MP'
      Size = 10
    end
    object sqlGramaticaSUFIXO_FS: TStringField
      FieldName = 'SUFIXO_FS'
      Size = 10
    end
    object sqlGramaticaSUFIXO_FP: TStringField
      FieldName = 'SUFIXO_FP'
      Size = 10
    end
  end
  object dtsPalavraGramatical: TDataSource
    DataSet = sqlGramatica
    Left = 296
    Top = 96
  end
end
