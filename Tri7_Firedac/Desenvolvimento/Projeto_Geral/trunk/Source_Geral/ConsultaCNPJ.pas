...
begin
  try
    ...
    frmConsultaCNPJ.EditCNPJ.Text := FormataCNPJ(RetornaNumerico(vfCnpj));
  ...
  begin
    try
      ...
      begin
        ...
        vlDadosCNPJ.CodigoIBGE  := ACBrConsultaCNPJ1.IBGE_Municipio;
      end;
    Except
