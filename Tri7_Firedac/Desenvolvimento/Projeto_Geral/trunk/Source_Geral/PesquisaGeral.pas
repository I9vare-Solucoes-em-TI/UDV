...
uses windows, messages,
  ...
  cxGridDBCardView, cxButtons, cxControls,
  System.Actions,

  cxGridCustomLayoutView, cxGridCardView, Vcl.StdCtrls, cxClasses,
  cxGridCustomView, cxGridTableView, cxGraphics, cxLookAndFeels,
  cxLookAndFeelPainters, cxStyles, cxCustomData, cxFilter, cxData,
  cxDataStorage, cxNavigator, cxDBData, Vcl.Menus, dxSkinsCore,
  dxSkinOffice2007Black, dxSkinOffice2007Blue, dxSkinOffice2007Green,
  dxSkinOffice2007Pink, dxSkinOffice2007Silver, dxSkinscxPCPainter, cxContainer,
...
var
  ...
  IdxProcura : String;
  procedure MontaPesquisa(NomePesquisa, Tabela, CamposPesquisa, DescCamposPesquisa, CamposGrid, DescCamposGrid:String; ChavePesquisa:String; Var VetRetorno:TStringList; StoredParametros:String = ''; CondicaoAux:String = ''; OrderBy:String = ''; const vpPesquisaAll: Boolean = True);
...
begin
   ...
   try
     ...
     begin
        ...
        begin
          if not vpPesquisaAll then
            if ChavePesquisa <> '' then
              SqlText := SqlText + ' WHERE ' + ChavePesquisa + ' = 0 '
            else
