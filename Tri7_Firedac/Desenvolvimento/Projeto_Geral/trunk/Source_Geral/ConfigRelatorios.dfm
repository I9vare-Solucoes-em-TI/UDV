inherited frmConfigRelatorios: TfrmConfigRelatorios
  ...
  inherited PanelGeral: TPanel
    ...
    inherited PanelData: TPanel
      ...
      object Label1: TLabel
        ...
        Height = 13
        Caption = 
          '* Criar o grupo "Principal Relat'#243'rios" para os relat'#243'rios din'#226'mi' +
          'cos do menu principal'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -11
      ...
      object Label2: TLabel
        ...
        Height = 13
        Caption = 
          '* Somente relat'#243'rios "Ativos" aparecer'#227'o nos menus din'#226'micos dos' +
          ' sistemas'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -11
    ...
    object grdConfRel: TcxGrid
      ...
      object grdConfRelDBTableView1: TcxGridDBTableView
        ...
        object grdConfRelDBTableView1SITUACAO: TcxGridDBColumn
  ...
  object PopupMenu1: TPopupMenu
    ...
    object CorrigirProtesto1: TMenuItem
      Caption = 'Corrigir Protesto'
      object CorrigeBeletoCancelamento1: TMenuItem
        Caption = 'Corrige Boleto Cancelamento (Apenas Selecionado)'
        OnClick = CorrigeBeletoCancelamento1Click
      end
      object CorrigirRelatrios1: TMenuItem
        Caption = 'Corrigir Relat'#243'rios (Cancelamento e T'#237'tulos)'
        OnClick = CorrigirRelatrios1Click
      end
    end
  end
