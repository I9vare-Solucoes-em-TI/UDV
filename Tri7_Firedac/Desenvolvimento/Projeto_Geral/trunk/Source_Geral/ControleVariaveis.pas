...
begin
  ...
  begin
    if vpUsarCabSec = '1' then
         LerConfigTexto('ATO', 'IMPRESSAO', 'EDITOR', 'MARGEM') // Livro e Traslado - Cabeçalho Diferente e Margem Principal
    else LerConfigTexto('ATO', 'IMPRESSAO', 'EDITOR', 'MARGEM_SECUNDARIA'); // Livro e Traslado - Cabeçalho Diferente e Margem Secundária
  ...
  begin
    ...
    begin
      // Opção de Cabeçalhos para "livro e traslado principais" ou somente para "livro secundário"
