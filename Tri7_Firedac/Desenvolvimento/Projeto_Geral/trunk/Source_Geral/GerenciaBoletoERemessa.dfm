object frmGerenciaBoletoRemessa: TfrmGerenciaBoletoRemessa
      ...
      object pgcRemessa: TcxPageControl
        ...
        object tbsGerarRemessa: TcxTabSheet
          ...
          object Panel3: TPanel
            ...
            object btnValidarRemessa: TcxButton
              Left = 655
              Top = 4
              Width = 106
              Height = 25
              Caption = 'Validar Remessa'
              Colors.Default = clWhite
              Enabled = False
              LookAndFeel.Kind = lfUltraFlat
              LookAndFeel.NativeStyle = False
              ...
              Font.Style = []
              ParentFont = False
              OnClick = btnValidarRemessaClick
            end
            ...
            object btnSairRemessa: TcxButton
              Left = 767
              Top = 33
              Width = 106
              Height = 25
          ...
          object pgcGerarRemessa: TcxPageControl
            Left = 0
            Top = 64
            Width = 1207
            Height = 458
            Align = alClient
            TabOrder = 1
            Properties.ActivePage = tbsBoletosRemessa
            Properties.CustomButtons.Buttons = <>
            ClientRectBottom = 458
            ClientRectRight = 1207
            ClientRectTop = 24
            object tbsBoletosRemessa: TcxTabSheet
              Caption = 'Boletos'
              ImageIndex = 0
            ...
            object tbsBoletoValidacao: TcxTabSheet
              ...
              object cxGrid1: TcxGrid
                ...
                Height = 279
                Hint = 
                  'Selecione a op'#231#227'o de corrigir com o bot'#227'o direito do mouse ao cl' +
                  'icar no grig'
                Align = alClient
                PopupMenu = ppmCorrigirRemessa
                TabOrder = 0
                ExplicitTop = 0
                ExplicitHeight = 296
                object cxGridDBTableView4: TcxGridDBTableView
                  ...
                  FilterBox.CustomizeDialog = False
                  FilterBox.Position = fpTop
                  DataController.DataSource = dtsValidarRemessa
                  DataController.Summary.DefaultGroupSummaryItems = <>
                  DataController.Summary.FooterSummaryItems = <>
                  DataController.Summary.SummaryGroups = <>
                  Filtering.MRUItemsListCount = 5
                  ...
                  Styles.GroupByBox = dtmControles.cxStyle7
                  Styles.StyleSheet = dtmControles.GridTableViewStyleSheetDevExpress
                  object cxGridBOLETO_ID: TcxGridDBColumn
                    Caption = 'Boleto ID'
                    DataBinding.FieldName = 'BOLETO_ID'
                    Options.Editing = False
                    Options.Focusing = False
                  ...
                  object cxGridNOSSO_NUMERO: TcxGridDBColumn
                    Caption = 'Nosso N'#186
                    DataBinding.FieldName = 'NOSSO_NUMERO'
                    Options.Editing = False
                    Options.Focusing = False
                  ...
                  object cxGridCPFCNPJ: TcxGridDBColumn
                    Caption = 'CPF/CNPJ Sacado'
                    DataBinding.FieldName = 'CPFCNPJ'
                    OnGetDisplayText = grdBoletoDBTableView1CPFCNPJGetDisplayText
                    Options.Editing = False
                  ...
                  object cxGridDBTableView4LOGRADOURO: TcxGridDBColumn
                    Caption = 'Logradouro'
                  ...
                  object cxGridCIDADE: TcxGridDBColumn
                    Caption = 'Cidade'
                    DataBinding.FieldName = 'CIDADE'
                    Options.Editing = False
                    Options.Focusing = False
                  ...
                  object cxGridUF: TcxGridDBColumn
                    DataBinding.FieldName = 'UF'
                    Options.Editing = False
                    Options.Focusing = False
                    Width = 20
                  end
                  object cxGridDBTableView4CEP: TcxGridDBColumn
              ...
              object cxGroupBox7: TcxGroupBox
                ...
                Top = 296
                Align = alBottom
                Caption = 'Erros Valida'#231#227'o:'
                ParentFont = False
                Style.StyleController = dtmControles.cxEditStyleGroup
                TabOrder = 1
                Height = 138
                Width = 1207
                object mmoValidacao: TcxDBMemo
                  Left = 2
                  Top = 18
                  Align = alClient
                  DataBinding.DataField = 'TEXTO'
                  DataBinding.DataSource = dtsValidarRemessa
                  ParentFont = False
              ...
              object cxLabel8: TcxLabel
                ...
                Align = alTop
                Caption = 
                  '*Selecione a op'#231#227'o de corrigir com o bot'#227'o direito do mouse ao c' +
                  'licar no grig'
                ParentFont = False
                Style.Shadow = False
                Style.TextColor = clRed
  ...
  object tblValidarRemessa: TI9MemTable
    Active = True
    FieldDefs = <
      item
        Name = 'BOLETO_ID'
    ...
    Left = 40
    Top = 168
    object tblValidarRemessaBOLETO_ID: TBCDField
      FieldName = 'BOLETO_ID'
      Origin = 'BOLETO_ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object tblValidarRemessaNOSSO_NUMERO: TStringField
      FieldName = 'NOSSO_NUMERO'
      Origin = 'NOSSO_NUMERO'
      Size = 30
    end
    object tblValidarRemessaNOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NOME'
      Origin = 'NOME'
      ProviderFlags = []
    ...
    object tblValidarRemessaCPFCNPJ: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CPFCNPJ'
      Origin = 'CPFCNPJ'
      ProviderFlags = []
    ...
    object tblValidarRemessaLOGRADOURO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOGRADOURO'
      Origin = 'LOGRADOURO'
      ProviderFlags = []
    ...
    object tblValidarRemessaBAIRRO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'BAIRRO'
      Origin = 'BAIRRO'
      ProviderFlags = []
    ...
    object tblValidarRemessaCIDADE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CIDADE'
      Origin = 'CIDADE'
      ProviderFlags = []
    ...
    object tblValidarRemessaUF: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'UF'
      Origin = 'UF'
      ProviderFlags = []
    ...
    object tblValidarRemessaCEP: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CEP'
      Origin = 'CEP'
      ProviderFlags = []
    ...
    object tblValidarRemessaTEXTO: TMemoField
      FieldName = 'TEXTO'
      BlobType = ftMemo
    end
  end
  object dtsValidarRemessa: TDataSource
    DataSet = tblValidarRemessa
    Left = 153
    Top = 170
  end
  object ppmCorrigirRemessa: TPopupMenu
    Images = dtmControles.imgCadBasicos
    OnPopup = ppmCorrigirRemessaPopup
    Left = 840
    Top = 216
    object CorrigirRemessa1: TMenuItem
      Caption = 'Corrigir Remessa'
      ImageIndex = 2
      OnClick = CorrigirRemessa1Click
    end
  end
end
