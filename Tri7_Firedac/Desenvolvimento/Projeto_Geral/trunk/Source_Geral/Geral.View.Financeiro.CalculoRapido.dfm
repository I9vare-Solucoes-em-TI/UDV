object frmCalculoRapido: TfrmCalculoRapido
  ...
  object tbcSistemas: TcxTabControl
    ...
    object Panel1: TPanel
        ...
        object cxGrid1: TcxGrid
          ...
          object gridItensCalcRapido: TcxGridDBTableView
            ...
            object gridItensCalcRapidoNaturezaTitulo: TcxGridDBColumn
              Caption = 'Natureza'
              DataBinding.FieldName = 'NaturezaDescricao'
              Width = 127
            end
      ...
      object lcxNaturezaTitulo: TcxLookupComboBox
        ...
        Properties.ListOptions.ShowHeader = False
        Properties.ListSource = dtsTipoNatureza
  ...
  object ClientItensCalcRapido: TClientDataSet
    ...
    object ClientItensCalcRapidoTabelaCalculoDescricao: TStringField
      FieldName = 'TabelaCalculoDescricao'
      Size = 260
    end
  ...
  object sqlTipoNatureza: TI9Query
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    Left = 376
    Top = 272
    object sqlTipoNaturezaNATUREZA_TITULO_ID: TBCDField
      FieldName = 'NATUREZA_TITULO_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlTipoNaturezaDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 60
    end
    object sqlTipoNaturezaEMOLUMENTO_ID: TBCDField
      FieldName = 'EMOLUMENTO_ID'
      Precision = 20
      Size = 2
    end
  end
  object dtsTipoNatureza: TDataSource
    DataSet = sqlTipoNatureza
    Left = 379
    Top = 316
  end
  ...
  object sqlEmolumentoTodos: TI9Query
    ...
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'SELECT'#13#10'EMOLUMENTO_ID,'#13#10'DESCRICAO'#13#10'FROM'#13#10'G_EMOLUMENTO')
    Left = 221
    Top = 327
  ...
  object sqlTipoNaturezaTodos: TI9Query
    Connection = dtmControles.DB
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
    ...
    Left = 219
    Top = 377
    object sqlTipoNaturezaTodosNATUREZA_TITULO_ID: TBCDField
      FieldName = 'NATUREZA_TITULO_ID'
      Required = True
      Precision = 20
      Size = 2
    end
    object sqlTipoNaturezaTodosDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 60
    end
