...
begin
  ...
  if not viFlag then
  begin
    Application.MessageBox('Nenhum Boleto Selecionado!','Informação', MB_OK + MB_ICONINFORMATION);
    Exit;
  end;
...
var
  viBoletoId : String;
begin
  if Application.MessageBox('Ignorar envio de email nos Itens Marcados?', 'Confirmação', MB_YESNO) = IDNO then
    exit;
