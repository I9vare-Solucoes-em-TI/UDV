inherited frmCadRelatorioFinanceiro: TfrmCadRelatorioFinanceiro
  ...
  inherited Panel1: TPanel
    ...
    object tabBalancete: TcxTabControl
      ...
      object icxCNJ: TcxImageComboBox
        Left = 243
        Top = 83
        EditValue = 'T'
        ParentFont = False
      ...
      object imgTipoRelatorio: TcxImageComboBox
        Left = 354
        Top = 83
        EditValue = '1'
        ParentFont = False
        Properties.Items = <
          ...
          item
            Description = 'Di'#225'rio'
            Value = '3'
          end
          item
            Description = 'Somat'#243'rio'
            Value = '4'
          end
          item
          ...
          item
            Description = 'Concilia'#231#227'o Banc'#225'ria'
            Value = '6'
          end
          item
        ...
        Properties.OnChange = imgTipoRelatorioPropertiesChange
        Style.StyleController = dtmControles.cxEsc_EditsObrigatorio
        TabOrder = 11
        Width = 239
      end
      object cxGroupBox1: TcxGroupBox
        ...
        object lcxCentroCusto: TcxLookupComboBox
          Left = 125
          Top = 144
          RepositoryItem = dtmLookupContabil.Lista_CentroCustoTipo1
          ParentFont = False
          Properties.KeyFieldNames = 'PESSOA_ID'
          Properties.ListColumns = <
            item
      ...
      object chxSomarExcluidos: TcxCheckBox
        Left = 19
        Top = 109
        Caption = 'Itens/Caixa de Caixa Saldo Previs'#227'o Bloqueado'
        State = cbsChecked
        TabOrder = 15
        Width = 261
      end
  ...
  object sqlRelatorioAnalitico: TI9Query
    ...
    SQL.Strings = (
      ...
      'AS GRUPO_SECUDARIO,'#13#10'       CG.DESCRICAO AS GRUPO_PRINCIPAL,'#13#10'  ' +
      '     BG.DESCRICAO AS BALANCETE_GRUPO,'#13#10'       P.NOME,'#13#10'        (' +
      'SELECT FIRST 1 PP.NOME AS CLIENTE FROM'#13#10'         J_PROCESSO_PART' +
      'E PP '#13#10'         WHERE PP.PRINCIPAL = '#39'S'#39#13#10'           AND PP.PROC' +
      'ESSO_ID = LC.PROCESSO_ID)'#13#10'FROM J_LIVRO_CAIXA LC'#13#10'  LEFT OUTER J' +
      'OIN J_LIVRO_FINANCEIRO LF ON'#13#10'  LC.LIVRO_FINANCEIRO_ID = LF.LIVR' +
      'O_FINANCEIRO_ID'#13#10'  LEFT OUTER JOIN J_CONTABIL_CONTA CC ON'#13#10'  LC.' +
      'CONTABIL_CONTA_ID = CC.CONTABIL_CONTA_ID'#13#10'  LEFT OUTER JOIN J_CO' +
      'NTABIL_GRUPO CG ON'#13#10'  CC.CONTABIL_GRUPO_ID = CC.CONTABIL_GRUPO_I' +
      'D'#13#10'  LEFT OUTER JOIN J_PESSOA P ON'#13#10'  LC.PESSOA_ID = P.PESSOA_ID' +
    ...
    object sqlRelatorioAnaliticoCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Size = 120
    end
  ...
  object sqlRelatorioSimplificado: TI9Query
    ...
    SQL.Strings = (
      ...
      ' CG.DESCRICAO AS GRUPO_PRINCIPAL,'#13#10'        BG.DESCRICAO AS BALAN' +
      'CETE_GRUPO,'#13#10'        LC.BALANCETE_GRUPO_ID'#13#10' FROM J_LIVRO_CAIXA ' +
      'LC'#13#10'   LEFT OUTER JOIN J_LIVRO_FINANCEIRO LF ON'#13#10'   LC.LIVRO_FIN' +
      'ANCEIRO_ID = LF.LIVRO_FINANCEIRO_ID'#13#10'   LEFT OUTER JOIN J_CONTAB' +
      'IL_CONTA CC ON'#13#10'   LC.CONTABIL_CONTA_ID = CC.CONTABIL_CONTA_ID'#13#10 +
      '   LEFT OUTER JOIN J_CONTABIL_GRUPO CG ON'#13#10'   CC.CONTABIL_GRUPO_' +
      'ID = CG.CONTABIL_GRUPO_ID'#13#10'   LEFT OUTER JOIN J_BALANCETE_GRUPO ' +
      'BG ON'#13#10'   LC.BALANCETE_GRUPO_ID = BG.BALANCETE_GRUPO_ID'#13#10' WHERE ' +
    ...
    object sqlRelatorioSimplificadoQTD: TIntegerField
      FieldName = 'QTD'
    end
  end
  ...
  object sqlRelatorioDiario: TI9Query
    ...
    SQL.Strings = (
      ...
      '_NOME, LC.DOC_TIPO,'#13#10'       CC.DESCRICAO AS CONTABIL_CONTA_DESCR' +
      'ICAO,'#13#10'       CC.GRUPO AS GRUPO_SECUDARIO,'#13#10'       CG.DESCRICAO ' +
      'AS GRUPO_PRINCIPAL,'#13#10'       P.NOME, LC.ESPECIE, LC.CONTABIL_RL,'#13 +
      #10'       BG.DESCRICAO AS BALANCETE_GRUPO, '#13#10'       (SELECT C1.DES' +
      'CRICAO FROM J_LIVRO_CAIXA LC1 '#13#10'        INNER JOIN J_CAIXA C1 ON' +
      #13#10'        C1.CAIXA_ID = LC1.CAIXA_ID'#13#10'        WHERE LC1.CAIXA_TR' +
      'ANSFERENCIA_ID = LC.CAIXA_TRANSFERENCIA_ID'#13#10'        AND NOT LC1.' +
      'OPERACAO = LC.OPERACAO) AS CAIXA_DESTINO'#13#10'FROM J_LIVRO_CAIXA LC'#13 +
      #10'  LEFT OUTER JOIN J_CONTABIL_CONTA CC ON'#13#10'  LC.CONTABIL_CONTA_I' +
      'D = CC.CONTABIL_CONTA_ID'#13#10'  LEFT OUTER JOIN J_CONTABIL_GRUPO CG ' +
      'ON'#13#10'  CC.CONTABIL_GRUPO_ID = CG.CONTABIL_GRUPO_ID'#13#10'  LEFT OUTER ' +
      'JOIN J_PESSOA P ON'#13#10'  LC.PESSOA_ID = P.PESSOA_ID'#13#10'  LEFT OUTER J' +
      'OIN J_BALANCETE_GRUPO BG ON'#13#10'  LC.BALANCETE_GRUPO_ID = BG.BALANC' +
      'ETE_GRUPO_ID'#13#10'  LEFT OUTER JOIN J_CAIXA C ON'#13#10'  LC.CAIXA_ID = C.' +
      'CAIXA_ID'#13#10'WHERE NOT LC.LIVRO_CAIXA_ID IS NULL'#13#10'  AND LC.DATA_PAG' +
    ...
    object sqlRelatorioDiarioESPECIE: TStringField
      FieldName = 'ESPECIE'
      Size = 1
    end
    object sqlRelatorioDiarioCONTABIL_RL: TStringField
    ...
    object sqlRelatorioDiarioCONTABIL_HISTORICO: TStringField
      FieldName = 'CONTABIL_HISTORICO'
      Size = 260
    end
    object sqlRelatorioDiarioCONTABIL_PESSOA_NOME: TStringField
      FieldName = 'CONTABIL_PESSOA_NOME'
      Size = 120
    end
    object sqlRelatorioDiarioDOC_TIPO: TStringField
      FieldName = 'DOC_TIPO'
      Size = 1
    end
  end
  ...
  object frxDBDatasetDiario: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'VALOR=VALOR'
      'CONTABIL_HISTORICO=CONTABIL_HISTORICO'
      'CONTABIL_PESSOA_NOME=CONTABIL_PESSOA_NOME'
      'DOC_TIPO=DOC_TIPO')
  ...
  object ClientCaixa: TClientDataSet
    PersistDataPacket.Data = {
      ...
      53554D4F0100490000000100055749445448020002003C000E50524556495341
  ...
  object sqlRelatorioCentroCusto: TI9Query
    ...
    SQL.Strings = (
      ...
      'ERACAO,'#13#10'       LC.DOCUMENTO_NUMERO, LC.HISTORICO, LC.OBSERVACAO' +
      ', LC.CAIXA_ID,'#13#10'       LC.CONTABIL_HISTORICO, LC.CONTABIL_PESSOA' +
      '_NOME,'#13#10'       CC.DESCRICAO AS CONTABIL_CONTA_DESCRICAO, LC.DOC_' +
      'TIPO,'#13#10'       CC.GRUPO AS GRUPO_SECUDARIO,'#13#10'       CG.DESCRICAO ' +
      'AS GRUPO_PRINCIPAL,'#13#10'       P.NOME, LC.ESPECIE, LC.CONTABIL_RL,'#13 +
      #10'       BG.DESCRICAO AS BALANCETE_GRUPO,'#13#10'       (SELECT C1.DESC' +
      'RICAO FROM J_LIVRO_CAIXA LC1'#13#10'        INNER JOIN J_CAIXA C1 ON'#13#10 +
      '        C1.CAIXA_ID = LC1.CAIXA_ID'#13#10'        WHERE LC1.CAIXA_TRAN' +
      'SFERENCIA_ID = LC.CAIXA_TRANSFERENCIA_ID'#13#10'        AND NOT LC1.OP' +
      'ERACAO = LC.OPERACAO) AS CAIXA_DESTINO,'#13#10'        '#13#10'       CASE'#13#10 +
      '         WHEN CR.PERCENTUAL > 0 THEN (CR.PERCENTUAL * LC.VALOR)/' +
      '100'#13#10'       ELSE LC.VALOR'#13#10'       END AS VALOR_REGISTRADO,'#13#10#13#10'  ' +
      '     CASE'#13#10'         WHEN CR.PERCENTUAL > 0 THEN CR.PERCENTUAL'#13#10' ' +
      '      ELSE 100'#13#10'       END AS PERCENTUAL_REGISTRADO,'#13#10#13#10'       C' +
      'ASE'#13#10'         WHEN CR.PERCENTUAL > 0 THEN CT.DESCRICAO'#13#10'       E' +
      'LSE  (SELECT CC1.DESCRICAO FROM J_CENTRO_CUSTO CC1'#13#10'            ' +
      '  WHERE CC1.CENTRO_CUSTO_ID = LC.CENTRO_CUSTO_ID'#13#10'              ' +
      'AND CC1.TIPO_ITEM = '#39'1'#39')'#13#10'       END AS CENTRO_CUSTO_REGISTRADO'#13 +
      #10'       '#13#10'FROM J_LIVRO_CAIXA LC'#13#10'  LEFT OUTER JOIN J_CONTABIL_CO' +
      'NTA CC ON'#13#10'  LC.CONTABIL_CONTA_ID = CC.CONTABIL_CONTA_ID'#13#10'  LEFT' +
      ' OUTER JOIN J_CONTABIL_GRUPO CG ON'#13#10'  CC.CONTABIL_GRUPO_ID = CG.' +
      'CONTABIL_GRUPO_ID'#13#10'  LEFT OUTER JOIN J_PESSOA P ON'#13#10'  LC.PESSOA_' +
      'ID = P.PESSOA_ID'#13#10'  LEFT OUTER JOIN J_BALANCETE_GRUPO BG ON'#13#10'  L' +
      'C.BALANCETE_GRUPO_ID = BG.BALANCETE_GRUPO_ID'#13#10'  LEFT OUTER JOIN ' +
      'J_CAIXA C ON'#13#10'  LC.CAIXA_ID = C.CAIXA_ID'#13#10'  LEFT OUTER JOIN J_CE' +
      'NTRO_RATEIO CR ON'#13#10'  CR.LIVRO_CAIXA_ID = LC.LIVRO_CAIXA_ID'#13#10'  LE' +
      'FT OUTER JOIN J_CENTRO_CUSTO CT ON'#13#10'  CT.CENTRO_CUSTO_ID = CR.CE' +
      'NTRO_CUSTO_ID'#13#10'WHERE NOT LC.LIVRO_CAIXA_ID IS NULL'#13#10'  AND LC.DAT' +
    ...
    object sqlRelatorioCentroCustoCENTRO_CUSTO_REGISTRADO: TStringField
      FieldName = 'CENTRO_CUSTO_REGISTRADO'
      Size = 120
    end
    object sqlRelatorioCentroCustoESPECIE: TStringField
      FieldName = 'ESPECIE'
      Size = 1
    end
    object sqlRelatorioCentroCustoCONTABIL_RL: TStringField
      FieldName = 'CONTABIL_RL'
      Size = 1
    end
    object sqlRelatorioCentroCustoCONTABIL_HISTORICO: TStringField
      FieldName = 'CONTABIL_HISTORICO'
      Size = 260
    end
    object sqlRelatorioCentroCustoCONTABIL_PESSOA_NOME: TStringField
      FieldName = 'CONTABIL_PESSOA_NOME'
      Size = 120
    end
    object sqlRelatorioCentroCustoDOC_TIPO: TStringField
      FieldName = 'DOC_TIPO'
      Size = 1
    end
  end
  object dtsCentroCusto: TDataSource
    DataSet = sqlRelatorioCentroCusto
    Left = 26
    Top = 341
  end
  object frxDBDatasetDiarioCentroCusto: TfrxDBDataset
    UserName = 'frxDBDatasetDiarioCentroCusto'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CAIXA=CAIXA'
      'DATA_PAGAMENTO=DATA_PAGAMENTO'
      ...
      'PERCENTUAL_REGISTRADO=PERCENTUAL_REGISTRADO'
      'CENTRO_CUSTO_REGISTRADO=CENTRO_CUSTO_REGISTRADO'
      'ESPECIE=ESPECIE'
      'CONTABIL_RL=CONTABIL_RL'
      'CONTABIL_HISTORICO=CONTABIL_HISTORICO'
      'CONTABIL_PESSOA_NOME=CONTABIL_PESSOA_NOME'
  ...
  object sqlConciliacaoBancaria: TI9Query
    ...
    SQL.Strings = (
      ...
      'DESCRICAO,LC.DOC_TIPO,'#13#10'       CC.GRUPO AS GRUPO_SECUDARIO,'#13#10'   ' +
      '    CG.DESCRICAO AS GRUPO_PRINCIPAL,'#13#10'       LC.CONTABIL_RL,  P.' +
      'NOME,'#13#10'       BG.DESCRICAO AS BALANCETE_GRUPO,'#13#10'       CR.DESCRI' +
      'CAO AS CONC_DESCRICAO, CR.VALOR AS CONCVALOR, CR.DATA_PAGAMENTO,' +
      #13#10'       CR.OBSERVACAO AS CONC_OBSERVACAO'#13#10'FROM J_CONCILIACAO CB' +
      #13#10'  LEFT OUTER JOIN J_CONCILIACAO_REGISTRADO CR ON'#13#10'  CB.CONCILI' +
      'ACAO_ID = CR.CONCILIACAO_ID'#13#10'  LEFT OUTER JOIN J_LIVRO_CAIXA LC ' +
      'ON'#13#10'  CR.CONCILIACAO_REGISTRADO_ID = LC.CONCILIACAO_REGISTRADO_I' +
      'D'#13#10'  LEFT OUTER JOIN J_CONTABIL_CONTA CC ON'#13#10'  LC.CONTABIL_CONTA' +
      '_ID = CC.CONTABIL_CONTA_ID'#13#10'  LEFT OUTER JOIN J_CONTABIL_GRUPO C' +
      'G ON'#13#10'  CC.CONTABIL_GRUPO_ID = CG.CONTABIL_GRUPO_ID'#13#10'  LEFT OUTE' +
      'R JOIN J_PESSOA P ON'#13#10'  LC.PESSOA_ID = P.PESSOA_ID'#13#10'  LEFT OUTER' +
      ' JOIN J_BALANCETE_GRUPO BG ON'#13#10'  LC.BALANCETE_GRUPO_ID = BG.BALA' +
      'NCETE_GRUPO_ID'#13#10'  LEFT OUTER JOIN J_CAIXA C ON'#13#10'  LC.CAIXA_ID = ' +
    ...
    Left = 526
    Top = 102
    object sqlConciliacaoBancariaCONCILIACAO_REGISTRADO_ID: TStringField
      FieldName = 'CONCILIACAO_REGISTRADO_ID'
      Size = 15
    end
    object sqlConciliacaoBancariaCAIXA: TStringField
      FieldName = 'CAIXA'
      Size = 60
    end
    ...
    object sqlConciliacaoBancariaOPERACAO: TStringField
      FieldName = 'OPERACAO'
      Size = 3
    end
    object sqlConciliacaoBancariaDOCUMENTO_NUMERO: TStringField
      FieldName = 'DOCUMENTO_NUMERO'
      Size = 60
    end
    object sqlConciliacaoBancariaHISTORICO: TStringField
      FieldName = 'HISTORICO'
      Size = 90
    end
    object sqlConciliacaoBancariaOBSERVACAO: TStringField
      FieldName = 'OBSERVACAO'
      Size = 260
    end
    ...
    object sqlConciliacaoBancariaCONTABIL_CONTA_DESCRICAO: TStringField
      FieldName = 'CONTABIL_CONTA_DESCRICAO'
      Size = 60
    end
    object sqlConciliacaoBancariaGRUPO_SECUDARIO: TStringField
      FieldName = 'GRUPO_SECUDARIO'
      Size = 60
    end
    object sqlConciliacaoBancariaGRUPO_PRINCIPAL: TStringField
      FieldName = 'GRUPO_PRINCIPAL'
      Size = 90
    end
    object sqlConciliacaoBancariaNOME: TStringField
      FieldName = 'NOME'
      Size = 120
    end
    object sqlConciliacaoBancariaBALANCETE_GRUPO: TStringField
      FieldName = 'BALANCETE_GRUPO'
      Size = 60
    end
    object sqlConciliacaoBancariaCONC_DESCRICAO: TStringField
    ...
    object sqlConciliacaoBancariaCONC_OBSERVACAO: TStringField
      FieldName = 'CONC_OBSERVACAO'
      Size = 120
    end
    object sqlConciliacaoBancariaDATA_PAGAMENTO: TSQLTimeStampField
      FieldName = 'DATA_PAGAMENTO'
    end
    object sqlConciliacaoBancariaCONTABIL_RL: TStringField
      FieldName = 'CONTABIL_RL'
      Size = 1
    end
    object sqlConciliacaoBancariaDOC_TIPO: TStringField
      FieldName = 'DOC_TIPO'
      Size = 1
    end
  end
  object dtsConciliacaoBancaria: TDataSource
    DataSet = sqlConciliacaoBancaria
    Left = 524
    Top = 153
  end
  object frxDBDatasetConciliacaoBancaria: TfrxDBDataset
    UserName = 'frxDBDatasetConciliacaoBancaria'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CONCILIACAO_REGISTRADO_ID=CONCILIACAO_REGISTRADO_ID'
      'CAIXA=CAIXA'
      'VALOR=VALOR'
      'OPERACAO=OPERACAO'
      'DOCUMENTO_NUMERO=DOCUMENTO_NUMERO'
      ...
      'NOME=NOME'
      'BALANCETE_GRUPO=BALANCETE_GRUPO'
      'CONC_DESCRICAO=CONC_DESCRICAO'
      'CONCVALOR=CONCVALOR'
      'CONC_OBSERVACAO=CONC_OBSERVACAO'
      'DATA_PAGAMENTO=DATA_PAGAMENTO'
      'CONTABIL_RL=CONTABIL_RL'
      'DOC_TIPO=DOC_TIPO')
    DataSource = dtsConciliacaoBancaria
    BCDToCurrency = False
    Left = 309
    Top = 364
  end
  object frxDBDatasetcABECALHO: TfrxDBDataset
    ...
    DataSet = dtmLookupContabil.sqlCabecalho
    BCDToCurrency = False
    Left = 262
    Top = 234
  end
  object sqlFaturamentoDetalhado: TI9Query
    ...
    SQL.Strings = (
      ...
      'IVRO_FINANCEIRO_ID = LC.LIVRO_FINANCEIRO_ID) AS DATA_PAGAMENTO, ' +
      #13#10'       LC.HISTORICO,'#13#10'       LF.LIVRO_CAIXA_FATURADO_ID,'#13#10'    ' +
      '   TM.DESCRICAO AS MODALIDADE,'#13#10'       LF.CONTABIL_CONTA_ID,'#13#10'  ' +
      '     SUM(LF.VALOR_AGENDADO) AS VALOR,'#13#10'       LF.OPERACAO,'#13#10'    ' +
      '   P.NOME,'#13#10'       LC.VALOR AS VALOR_PAGO,'#13#10'       CC.DESCRICAO ' +
      'AS COMPROMISSO'#13#10'FROM J_LIVRO_FINANCEIRO LF'#13#10'  LEFT OUTER JOIN J_' +
      'PESSOA P ON'#13#10'  LF.PESSOA_ID = P.PESSOA_ID'#13#10'  LEFT OUTER JOIN J_C' +
      'ONTABIL_CONTA CC ON'#13#10'  LF.CONTABIL_CONTA_ID = CC.CONTABIL_CONTA_' +
      'ID'#13#10'  LEFT OUTER JOIN J_LIVRO_CAIXA LC ON'#13#10'  LF.LIVRO_CAIXA_FATU' +
      'RADO_ID = LC.LIVRO_CAIXA_ID'#13#10'  LEFT OUTER JOIN J_TIPO_MODALIDADE' +
      ' TM ON'#13#10'  LF.TIPO_MODALIDADE_ID = TM.TIPO_MODALIDADE_ID'#13#10'WHERE L' +
      'C.DATA_PAGAMENTO BETWEEN '#39'01.10.2018'#39' AND '#39'30.10.2018'#39#13#10'  AND LF' +
      '.LIVRO_CAIXA_FATURADO_ID > 0'#13#10'GROUP BY'#13#10'      LC.LIVRO_FINANCEIR' +
    ...
    Left = 630
    Top = 86
    object sqlFaturamentoDetalhadoDATA_FATURAMENTO: TSQLTimeStampField
      FieldName = 'DATA_FATURAMENTO'
    end
    object sqlFaturamentoDetalhadoHISTORICO: TStringField
      FieldName = 'HISTORICO'
      Size = 90
    end
    ...
    object sqlFaturamentoDetalhadoMODALIDADE: TStringField
    ...
    object sqlFaturamentoDetalhadoOPERACAO: TStringField
      FieldName = 'OPERACAO'
      Size = 3
    end
    object sqlFaturamentoDetalhadoNOME: TStringField
      FieldName = 'NOME'
      Size = 120
    end
    object sqlFaturamentoDetalhadoCOMPROMISSO: TStringField
    ...
    object sqlFaturamentoDetalhadoDATA_PAGAMENTO: TMemoField
      FieldName = 'DATA_PAGAMENTO'
      BlobType = ftMemo
    end
  ...
  object dtsFaturamentoDetalhado: TDataSource
    DataSet = sqlFaturamentoDetalhado
    Left = 628
    Top = 137
  end
  object frxDBDataSetFaturamentoDetalhado: TfrxDBDataset
    UserName = 'frxDBDataSetFaturamentoDetalhado'
    CloseDataSource = False
    FieldAliases.Strings = (
      'DATA_FATURAMENTO=DATA_FATURAMENTO'
      'HISTORICO=HISTORICO'
      'LIVRO_CAIXA_FATURADO_ID=LIVRO_CAIXA_FATURADO_ID'
      ...
      'DATA_PAGAMENTO=DATA_PAGAMENTO'
      'LIVRO_FINANCEIRO_ID=LIVRO_FINANCEIRO_ID')
    DataSource = dtsFaturamentoDetalhado
    BCDToCurrency = False
    Left = 432
    Top = 405
  end
