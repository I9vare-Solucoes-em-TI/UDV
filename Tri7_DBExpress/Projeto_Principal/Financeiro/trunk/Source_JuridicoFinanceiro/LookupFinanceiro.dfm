object dtmLookupFinanceiro: TdtmLookupFinanceiro
  ...
  object cxEditRepository2: TcxEditRepository
    ...
    object ListaTipoDocumento: TcxEditRepositoryLookupComboBoxItem
      Properties.CharCase = ecUpperCase
      Properties.DropDownListStyle = lsEditList
      Properties.GridMode = True
      Properties.KeyFieldNames = 'TIPO_DOCUMENTO_ID'
      Properties.ListColumns = <
        item
          FieldName = 'DESCRICAO'
        end>
    ...
    object ListaCedenteAtivos: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownListStyle = lsFixedList
      Properties.GridMode = True
      ...
      Properties.ListOptions.ShowHeader = False
      Properties.ListSource = dtsCedente
    end
    object ComboTipoModalidade: TcxEditRepositoryImageComboBoxItem
      Properties.Items = <
        item
          Description = 'Entrada'
          ImageIndex = 0
    ...
    object ListaGrupoIdentificacaoPesquisa: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownListStyle = lsFixedList
      Properties.KeyFieldNames = 'IDENTIFICACAO'
      Properties.ListColumns = <
        item
    ...
    object ComboCaixaTipos: TcxEditRepositoryImageComboBoxItem
      Properties.Items = <
        item
  ...
  object ClientItem: TClientDataSet
    PersistDataPacket.Data = {
      EB0200009619E0BD01000000180000001A000000000003000000EB020B434F4D
      ...
      
    ...
    object ClientItemDOCUMENTO_NUMERO: TStringField
      FieldName = 'DOCUMENTO_NUMERO'
      Size = 60
    end
    object ClientItemDOC_TIPO: TStringField
      FieldName = 'DOC_TIPO'
      Size = 3
    end
    object ClientItemTIPO_MODALIDADE_ID: TIntegerField
      FieldName = 'TIPO_MODALIDADE_ID'
    end
    object ClientItemTIPO_CARGA_ID: TIntegerField
      FieldName = 'TIPO_CARGA_ID'
    end
    object ClientItemRESERVA_ID: TIntegerField
      FieldName = 'RESERVA_ID'
    end
    object ClientItemORCAMENTO_ID: TIntegerField
      FieldName = 'ORCAMENTO_ID'
    end
    object ClientItemIR: TStringField
      FieldName = 'IR'
      Size = 1
    end
    object ClientItemCNJ: TStringField
      FieldName = 'CNJ'
      Size = 1
    end
    object ClientItemPERIODO_ID: TIntegerField
      FieldName = 'PERIODO_ID'
    end
    object ClientItemLIVRO_AGENDAMENTO_ID: TIntegerField
  ...
  object sqlBanco: TSimpleDataSet
    ...
    object sqlBancoMODALIDADE: TStringField
    ...
    object sqlBancoLOCAL_REMESSA: TStringField
  ...
  object sqlCedente: TSimpleDataSet
    ...
    object sqlCedenteRAZAO_SOCIAL: TStringField
  ...
  object sqlTipoDocumento: TSimpleDataSet
    ...
    Left = 262
    Top = 274
    object sqlTipoDocumentoDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 30
    end
  ...
  object ClientCentroCustos: TClientDataSet
    PersistDataPacket.Data = {
      
      000000000000}
    Active = True
    Aggregates = <>
    ...
    Left = 392
    Top = 276
    object ClientCentroCustosCENTRO_CUSTO_ID: TIntegerField
      FieldName = 'CENTRO_CUSTO_ID'
    end
    object ClientCentroCustosPORCENTAGEM: TCurrencyField
      FieldName = 'PORCENTAGEM'
    end
    object ClientCentroCustosSITUACAO: TStringField
      FieldName = 'SITUACAO'
      Size = 1
    end
    object ClientCentroCustosID: TIntegerField
      FieldName = 'ID'
    end
  end
  object dtsCentroCusto: TDataSource
    DataSet = ClientCentroCustos
    Left = 388
    Top = 340
  end
  object ClientCentroReserva: TClientDataSet
    PersistDataPacket.Data = {
      820000009619E0BD01000000180000000400000000000300000082000F43454E
      54524F5F435553544F5F494404000100000000000B504F5243454E544147454D
      080004000000010007535542545950450200490006004D6F6E65790008534954
    ...
    Left = 528
    Top = 284
    object ClientCentroReservaCENTRO_CUSTO_ID: TIntegerField
      FieldName = 'CENTRO_CUSTO_ID'
    end
    object ClientCentroReservaPORCENTAGEM: TCurrencyField
      FieldName = 'PORCENTAGEM'
    end
    object ClientCentroReservaSITUACAO: TStringField
      FieldName = 'SITUACAO'
      Size = 1
    end
    object ClientCentroReservaID: TIntegerField
      FieldName = 'ID'
    end
  end
  object dtsCentroReserva: TDataSource
    DataSet = ClientCentroReserva
    Left = 524
    Top = 348
  end
