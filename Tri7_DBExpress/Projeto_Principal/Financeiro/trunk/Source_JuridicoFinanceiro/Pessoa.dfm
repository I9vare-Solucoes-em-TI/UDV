inherited frmCadPessoa: TfrmCadPessoa
          ...
          object pnlIdentificacao: TPanel
            ...
            object pgcDadosPessoa: TcxPageControl
              ...
              object tabPessoaFisica: TcxTabSheet
                ...
                object lcxTipoDocumento: TcxDBLookupComboBox
                  Left = 10
                  Top = 25
                  RepositoryItem = dtmLookupFinanceiro.ListaTipoDocumento
                  DataBinding.DataField = 'TIPO_DOCUMENTO_ID'
                  DataBinding.DataSource = SourceAncestral
                  ParentFont = False
                  Properties.ListColumns = <>
                  Properties.ListSource = dtmLookupFinanceiro.dtsTipoDocumento
            ...
            object pnlDadosPrincipais: TPanel
              ...
              object lblIdentificacao: TcxLabel
                Left = 357
                Top = 4
                Caption = 'Grupo de Identifica'#231#227'o'
                Style.TextColor = 4210688
                Style.TextStyle = [fsUnderline]
                Transparent = True
              end
              ...
              object chbUtilizaBoleto: TcxDBCheckBox
                Left = 9
                Top = 80
                AutoSize = False
              ...
              object btnPesquiasrCNPJ: TcxButton
                Left = 322
                Top = 19
                Width = 28
                Height = 23
              ...
              object rdbCadastroSimplificado: TcxRadioButton
                Left = 112
                Top = 85
                Width = 141
                Height = 15
                ...
                TabOrder = 15
                TabStop = True
                OnClick = rdbCadastroSimplificadoClick
              end
              object rdbCadastroCompleto: TcxRadioButton
                Left = 252
                Top = 85
                Width = 127
                Height = 15
                ...
                TabOrder = 16
                OnClick = rdbCadastroCompletoClick
              end
            end
            object pgcEndereco: TcxPageControl
              Left = 0
              Top = 218
              Width = 641
              Height = 127
          ...
          object pnlDadosComplementares: TPanel
            ...
            object cxGroupBox2: TcxGroupBox
              ...
              object lcxEstadoCivil: TcxDBLookupComboBox
                ...
                Properties.ListSource = dtmLookup.dtsG_TB_EstadoCivil
                Style.StyleController = dtmControles.cxEsc_EditsObrigatorio
                TabOrder = 6
                Width = 181
              end
              object lcxProfissao: TcxDBLookupComboBox
                ...
                Properties.ListColumns = <>
                Properties.ListSource = dtmLookup.dtsG_TB_Profissao
        ...
        object tabBoleto: TcxTabSheet
          ...
          object pnlDadosBoleto: TPanel
            ...
            object cxLabel11: TcxLabel
              Left = 10
              Top = 3
              Caption = 'Descri'#231#227'o do Nome do Boleto'
              Style.TextColor = 4210688
              Style.TextStyle = [fsBold, fsUnderline]
              Transparent = True
            end
            object cxLabel25: TcxLabel
              Left = 10
              Top = 51
              Caption = 'Email de Envio do Boleto'
              Style.TextColor = 4210688
              Style.TextStyle = [fsBold, fsUnderline]
              Transparent = True
            end
            object edtDescricaoBoelto: TcxDBTextEdit
              Left = 12
              Top = 23
              DataBinding.DataField = 'BOLETO_DESCRICAO'
              DataBinding.DataSource = SourceAncestral
              ParentFont = False
              Properties.CharCase = ecUpperCase
              Style.StyleController = dtmControles.cxEsc_EditsNormal
            ...
            object chbEmailPrincipal: TcxDBCheckBox
              Left = 163
              Top = 49
              AutoSize = False
              Caption = 'Utiliza Email Principal do Cadastro'
              DataBinding.DataField = 'BOLETO_UTILIZA_EMAIL_PADRAO'
              DataBinding.DataSource = SourceAncestral
              ParentFont = False
              Properties.DisplayChecked = 'S'
              Properties.DisplayGrayed = 'N'
              ...
              TabOrder = 3
              Transparent = True
              OnClick = chbEmailPrincipalClick
              Height = 21
              Width = 222
            end
            object edtEmailBoleto: TcxDBTextEdit
              Left = 12
              Top = 71
            ...
            object cxLabel10: TcxLabel
              Left = 12
              Top = 99
              Caption = 'Imagem Logomarca Boleto'
              Style.TextColor = 4210688
              Style.TextStyle = [fsBold, fsUnderline]
              Transparent = True
            end
            object cxDBImageComboBox1: TcxDBImageComboBox
              Left = 12
              Top = 118
              DataBinding.DataField = 'BOLETO_LOGOMARCA'
              DataBinding.DataSource = SourceAncestral
              ParentFont = False
              Properties.Items = <
                item
                  Description = 'Logo Padr'#227'o'
                  ImageIndex = 0
                end
                item
                  Description = 'Logo Padr'#227'o'
                ...
                item
                  Description = 'Logo Cliente'
                  Value = '2'
                end
                item
                  Description = 'Sem Logomarca'
                  Value = '3'
                end>
              Style.StyleController = dtmControles.cxEsc_EditsNormal
              TabOrder = 6
  ...
  inherited ClientAncestral: TClientDataSet
    ...
    object ClientAncestralBOLETO_DESCRICAO: TStringField
    ...
    object ClientAncestralBOLETO_UTILIZA_EMAIL_PADRAO: TStringField
      FieldName = 'BOLETO_UTILIZA_EMAIL_PADRAO'
      Size = 1
    end
    ...
    object ClientAncestralCADASTRO_SIMPLIFICADO: TStringField
      FieldName = 'CADASTRO_SIMPLIFICADO'
      Size = 1
    end
    object ClientAncestralBOLETO_LOGOMARCA: TStringField
      FieldName = 'BOLETO_LOGOMARCA'
      Size = 1
    end
  end
