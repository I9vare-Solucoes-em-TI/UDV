      ...
      begin
        try
          if not FileExists(viDiretorioPadrao) then
           ...
           Application.MessageBox(Pchar('Local do Arquivo de Boleto não Encontrado!'+#13+#13+
                                        'Verifique o Local da Pasta em CADASTRO/CEDENTE/CONTAS BANCÁRIAS'), 'Informar', MB_OK + MB_ICONINFORMATION);
           Abort;
         end;
      end;
...
begin
  ...
  begin
    ...
    NumeroDocumento    := 'Nº Doc: ' + sqlLivroFinanceiroLIVRO_FINANCEIRO_ID.AsString;
    EspecieDoc         := 'DM';
    Aceite             := atNao;
  ...
  try
    ...
    case sqlBancoBANCO_NUMERO.AsInteger of
     ...
     try
       ...
       Application.MessageBox(Pchar('Local do Arquivo de Remessa não Encontrado!'+#13+#13+
                                   'Verifique o Local da Pasta em CADASTRO/CEDENTE/CONTAS BANCÁRIAS'), 'Informar', MB_OK + MB_ICONINFORMATION);
       Abort;
     end;
