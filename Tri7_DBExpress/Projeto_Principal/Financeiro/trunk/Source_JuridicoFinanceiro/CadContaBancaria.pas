...
begin
  VerificarPreenchimentoEDT_DB(cxBANCO_NOME.Text,'Descrição Banco',cxBANCO_NOME);
  VerificarPreenchimentoEDT_DB(cxBANCO_NUMERO.Text,'Número do Banco', cxBANCO_NUMERO);
  VerificarPreenchimentoEDT_DB(cxBANCO_DIGITO.Text,'Dígito do Banco ', cxBANCO_DIGITO);
  VerificarPreenchimentoEDT_DB(cxAGENCIA_NOME.Text,'Descrição Agência',cxAGENCIA_NOME);
  VerificarPreenchimentoEDT_DB(cxAGENCIA_NUMERO.Text,'Número da Agência', cxAGENCIA_NUMERO);
  VerificarPreenchimentoCBX_DB(cxAGENCIA_UF.Text,'UF Agência',cxAGENCIA_UF);
  VerificarPreenchimentoEDT_DB(cxCARTEIRA.Text,'Carteira', cxCARTEIRA);
  VerificarPreenchimentoEDT_DB(edtLocalBoleto.Text, 'Local Gravação do Boleto', edtLocalBoleto);
  VerificarPreenchimentoEDT_DB(edtLocalRemessa.Text, 'Local Gravação do Boleto', edtLocalRemessa);
  VerificarPreenchimentoLCX_DB(lcxCedente.Text,'Vinculo do Cedente', lcxCedente);
  VerificarPreenchimentoLCX_DB(lcxLayout.Text, 'Layout Padrão do Boleto', lcxLayout);
end;
