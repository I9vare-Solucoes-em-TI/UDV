...
type
  TfrmGerenciadorAcao = class(TForm)
    ...
    sqlAcaoVALOR: TBCDField;
    sqlAcaoOBSERVACAO: TBlobField;
    sqlAcaoACAO: TStringField;
    sqlAcaoRESUMO: TBlobField;
    sqlAcaoACAO_NATUREZA_ID: TBCDField;
    sqlAcaoACAO_TIPO_ID: TBCDField;
    sqlAcaoACAO_VARA_ID: TBCDField;
...
//  sqlAjusteProgramado.Connection      := dtmControles.DB;
 ...
 sqlAcao.ParamByName('ACAO_ID').AsBCD := 0;
 sqlAcao.Active := True;
