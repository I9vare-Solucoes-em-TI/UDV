object dtmLookupServico: TdtmLookupServico
  ...
  object sqlLivroAgendamento: TSimpleDataSet
    ...
    object sqlLivroAgendamentoCNJ: TStringField
      FieldName = 'CNJ'
      Size = 1
    end
    ...
    object sqlLivroAgendamentoCONTABIL_RL: TStringField
      FieldName = 'CONTABIL_RL'
      Size = 1
    end
    object sqlLivroAgendamentoDOC_TIPO: TStringField
      FieldName = 'DOC_TIPO'
      Size = 1
    end
  end
  ...
  object sqlFinanceiroAgendamento: TSimpleDataSet
    ...
    object sqlFinanceiroAgendamentoCNJ: TStringField
      FieldName = 'CNJ'
      Size = 1
    end
    object sqlFinanceiroAgendamentoCONTABIL_RL: TStringField
      FieldName = 'CONTABIL_RL'
      Size = 1
    end
  end
