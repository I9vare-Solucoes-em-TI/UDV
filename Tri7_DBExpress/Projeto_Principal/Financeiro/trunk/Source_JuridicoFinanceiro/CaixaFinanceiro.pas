...
begin
  VerificarPreenchimentoEDT_DB(edtDescricao.Text, 'Descrição Completa', edtDescricao);
  VerificarPreenchimentoEDT_DB(edtDescricaoResumida.Text, 'Descrição Resumida', edtDescricaoResumida);
  VerificarPreenchimentoICX_DB(lcxTipoCaixa.Text, 'Tipo do Caixa', lcxTipoCaixa);

  if chxConciliacao.Checked then
    VerificarPreenchimentoDTA_DB(edtDataConciliacao.Text, 'Data Conciliação', edtDataConciliacao);
