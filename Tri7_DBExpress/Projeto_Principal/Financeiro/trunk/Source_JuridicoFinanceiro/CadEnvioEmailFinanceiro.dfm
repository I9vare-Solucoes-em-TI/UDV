object frmCadEnvioEmailFinanceiro: TfrmCadEnvioEmailFinanceiro
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object pgcConfig: TcxPageControl
    ...
    object tabConexao: TcxTabSheet
      ...
      object Panel2: TPanel
        ...
        object edtAssuntoPadrao: TcxDBTextEdit
          Left = 364
          Top = 140
      ...
      object Panel3: TPanel
        ...
        object Panel5: TPanel
          ...
          object lcxEmailTextoPadrao: TcxLookupComboBox
            ...
            Properties.OnEditValueChanged = lcxEmailTextoPadraoPropertiesEditValueChanged
            Style.StyleController = dtmControles.cxEsc_EditsNormal
            TabOrder = 1
            Width = 366
          end
  ...
  object sqlBoletos: TI9Query
    ...
    SQL.Strings = (
      ...
      'EFT OUTER JOIN J_LIVRO_FINANCEIRO LF'#13#10'  ON BO.BOLETO_ID = LF.BOL' +
      'ETA_ID'#13#10'  LEFT OUTER JOIN J_PESSOA P'#13#10'  ON LF.PESSOA_ID = P.PESS' +
    ...
    object sqlBoletosBOLETO_DESCRICAO: TStringField
      FieldName = 'BOLETO_DESCRICAO'
      Size = 120
    end
    object sqlBoletosNOME: TStringField
      FieldName = 'NOME'
      Size = 120
    end
    object sqlBoletosEMAIL1: TStringField
      FieldName = 'EMAIL1'
      Size = 90
    end
    object sqlBoletosBOLETO_EMAIL: TStringField
      FieldName = 'BOLETO_EMAIL'
      Size = 120
    end
    object sqlBoletosCALC_EMAIL: TStringField
      FieldKind = fkCalculated
      FieldName = 'CALC_EMAIL'
      Size = 120
      Calculated = True
    end
    object sqlBoletosPATH_GERARPDF: TStringField
