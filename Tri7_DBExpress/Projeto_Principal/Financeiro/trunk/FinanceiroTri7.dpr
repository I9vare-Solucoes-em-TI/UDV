...
begin
  ...
  begin
    ...
    begin
      try
        ...
        His.Free;
        Ini.Free;
        Application.MessageBox(PWideChar('Não foi possivel acessar a base de historico!'+#13+#13+
  ...
  begin
    Application.MessageBox(PChar('Nome do executável está diferente do padrão!!!'+#13+#13+
