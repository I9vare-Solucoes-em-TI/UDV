...
uses
  ...
  frxExportRTF, IdHTTP,
  FundoTipo, Data.DBXFirebird, frxExportDOCX, frxExportBaseDialog, System.Types,
  frxExportXLSX, Rotinas;
...
type
  TPessoa = Record
    ...
    NomeTabela, RepresentantesCartao: string;
  end;
...
type
  ...
  public
    ...
    function CodPermissao(Rotina: string;
...
var
  ...
  procedure VerificarPreenchimentoCUR_DB(vpDado: Variant; vpNomeCampo: string; var vpCampo: TcxDBCurrencyEdit);
  procedure VerificarPreenchimentoCUR_TX(vpDado: Variant; vpNomeCampo: string; var vpCampo: TcxCurrencyEdit);
...
function TdtmControles.IsLoginAdmin(const vpLogin: string): Boolean;
begin
...
procedure VerificarPreenchimentoCUR_DB(vpDado: Variant; vpNomeCampo: string;
  var vpCampo: TcxDBCurrencyEdit);
begin
  if (vpDado = null) or (vpDado <= 0) then
  begin
...
procedure VerificarPreenchimentoCUR_TX(vpDado: Variant; vpNomeCampo: string;
