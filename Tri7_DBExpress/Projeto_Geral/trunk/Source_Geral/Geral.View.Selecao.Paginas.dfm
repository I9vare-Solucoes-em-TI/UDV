object frmSelecaoPaginas: TfrmSelecaoPaginas
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Sele'#231#227'o de P'#225'ginas'
  ClientHeight = 111
  ClientWidth = 457
  Color = 13034466
  ...
  object pnlOpcoes: TPanel
    ...
    Align = alClient
    TabOrder = 0
    object rdbTodas: TcxRadioButton
      Left = 10
      Top = 10
      Width = 50
      Height = 17
    ...
    object rdbPaginas: TcxRadioButton
      Left = 10
      Top = 38
      Width = 58
      Height = 17
    ...
    object edtPaginas: TcxTextEdit
      ...
      TabOrder = 1
      TextHint = 'Exemplo: 1-5, 6, 8, 10-13'
      OnKeyPress = edtPaginasKeyPress
      Width = 121
    end
  end
end
