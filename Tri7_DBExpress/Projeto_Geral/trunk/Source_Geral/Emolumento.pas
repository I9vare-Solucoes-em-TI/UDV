...
uses
  ...
  cxDropDownEdit, cxTextEdit, StdCtrls, cxButtons, cxContainer,
  cxMaskEdit, cxPC, ExtCtrls, cxSplitter, DBClient, SimpleDS,
  Vcl.Menus, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters,
  dxBarBuiltInMenu, cxStyles, cxCustomData, cxFilter, cxData, cxDataStorage,
  cxNavigator, cxDBData, cxImageComboBox, cxCurrencyEdit;
const
...
begin
  ...
  begin
    Active := False;
    DataSet.Params.ParamByName('EMOLUMENTO_ID').AsCurrency := sqlG_EmolumentoEMOLUMENTO_ID.AsCurrency;
    DataSet.Params.ParamByName('EMOLUMENTO_PERIODO_ID').AsCurrency := lcxEmolumentoPeriodo.EditValue;
    Active := True;
  end;
end;
