...
Type
  ...
  TfrmOrdemServicoSolicitar = class(TForm)
    ...
    ClientAncestralVALOR_SERVICO: TFMTBCDField;
    ClientAncestralVALOR_PAGO: TFMTBCDField;
    ClientAncestralOBSERVACAO: TStringField;
    ClientAncestralCAIXA_CHEQUE_ID: TFMTBCDField;
    ClientAncestralHORA_PAGAMENTO: TStringField;
    ClientAncestralCAIXA_ID: TFMTBCDField;
    ClientAncestralRECIBO_ID: TFMTBCDField;
    ClientAncestralTIPO_SERVICO: TStringField;
    ClientAncestralQTD: TFMTBCDField;
    ClientAncestralAPRESENTANTE: TStringField;
    ClientAncestralMENSALISTA_ID: TFMTBCDField;
    ClientAncestralQUITADO_CAIXA_ID: TFMTBCDField;
    ClientAncestralREGISTRADO: TStringField;
    ClientAncestralEMOLUMENTO: TFMTBCDField;
    ClientAncestralTAXA_JUDICIARIA: TFMTBCDField;
    ClientAncestralFUNDESP: TFMTBCDField;
    ClientAncestralDESCONTO: TFMTBCDField;
    ClientAncestralVALOR_DOCUMENTO: TFMTBCDField;
    ClientAncestralOUTRA_TAXA1: TFMTBCDField;
    ClientAncestralCHAVE_SERVICO_SEC: TFMTBCDField;
    ClientAncestralEMOLUMENTO_ITEM_ID: TFMTBCDField;
    ClientAncestralCAIXA_REGISTROSELO_ID: TFMTBCDField;
    ClientAncestralFUNDO_RI: TFMTBCDField;
    ClientAncestralVALOR_RECIBO: TFMTBCDField;
    ClientAncestralIMPORTADO: TStringField;
    ClientAncestralTAXA2: TFMTBCDField;
    ClientAncestralCODIGO: TStringField;
    ClientAncestralESPECIE_PAGAMENTO2: TStringField;
    ClientAncestralVALOR_PRIMEIRO: TFMTBCDField;
    ClientAncestralVALOR_SEGUNDO: TFMTBCDField;
    ClientAncestralTIPO_CAIXA: TStringField;
    ClientAncestralRECIBO_NOTAS_ID: TFMTBCDField;
    ClientAncestralMENSALISTA_GRUPO_ID: TFMTBCDField;
    ClientAncestralQTD_PAGA: TFMTBCDField;
    ClientAncestralCAIXA_DESTINO_ID: TFMTBCDField;
    ClientAncestralCAIXA_FECHAMENTO_SAIDA_ID: TFMTBCDField;
    ClientAncestralCAIXA_FECHAMENTO_ENTRADA_ID: TFMTBCDField;
    ClientAncestralREG_FINANCEIRO: TStringField;
    ClientAncestralSERVICO_PEDIDO_ID: TFMTBCDField;
    ClientAncestralTIPO_CARTAO_ID: TFMTBCDField;
    ...
    sqlCaixaItensCAIXA_ITEM_ID: TFMTBCDField;
    sqlCaixaItensCAIXA_SERVICO_ID: TFMTBCDField;
    sqlCaixaItensUSUARIO_SERVICO_ID: TFMTBCDField;
    sqlCaixaItensUSUARIO_CAIXA_ID: TFMTBCDField;
    sqlCaixaItensCHAVE_SERVICO: TFMTBCDField;
    ...
    sqlCaixaItensVALOR_SERVICO: TFMTBCDField;
    sqlCaixaItensVALOR_PAGO: TFMTBCDField;
    sqlCaixaItensOBSERVACAO: TStringField;
    sqlCaixaItensHORA_PAGAMENTO: TStringField;
    sqlCaixaItensCAIXA_ID: TFMTBCDField;
    sqlCaixaItensRECIBO_ID: TFMTBCDField;
    sqlCaixaItensTIPO_SERVICO: TStringField;
    sqlCaixaItensQTD: TFMTBCDField;
    sqlCaixaItensAPRESENTANTE: TStringField;
    sqlCaixaItensMENSALISTA_ID: TFMTBCDField;
    sqlCaixaItensREGISTRADO: TStringField;
    sqlCaixaItensTIPO_CAIXA: TStringField;
    sqlCaixaItensSISTEMA_ID: TFMTBCDField;
    ...
    sqlPesquisaOSUSUARIO_ID: TFMTBCDField;
    ...
    sqlServicosSequenciaisCAIXA_SERVICO_SEQUENCIAL_ID: TFMTBCDField;
    sqlServicosSequenciaisNATUREZA_TITULO_ID: TFMTBCDField;
    sqlServicosSequenciaisEMOLUMENTO_ID: TFMTBCDField;
    sqlServicosSequenciaisQUANTIDADE: TFMTBCDField;
    sqlServicosSequenciaisCAIXA_SERVICO_ID: TFMTBCDField;
    ...
    ClientItensSequenciaNATUREZA_TITULO_ID: TFMTBCDField;
    ClientItensSequenciaEMOLUMENTO_ID: TFMTBCDField;
    ClientItensSequenciaQUANTIDADE: TFMTBCDField;
    ClientItensSequenciaPADRAO_SELECAO: TStringField;
    ClientItensSequenciaCAIXA_SERVICO_ID: TFMTBCDField;
    ...
    sqlCaixaItensSERVICO_RETORNO_ENTRADA: TFMTBCDField;
    sqlCaixaItensSERVICO_RETONO_SAIDA: TFMTBCDField;
    sqlCaixaItensCALC_RETORNO: TStringField;
    sqlCaixaItensSERVICO_CONFIRMADO: TFMTBCDField;
    ...
    sqlItensVinculados: TSimpleDataSet;
    sqlItensVinculadosORDEM_ITEM_SEQUENCIA_ID: TFMTBCDField;
    sqlItensVinculadosCAIXA_ITEM_ID: TFMTBCDField;
    sqlItensVinculadosNATUREZA_TITULO_ID: TFMTBCDField;
    sqlItensVinculadosQUANTIDADE: TFMTBCDField;
    sqlItensVinculadosCAIXA_SERVICO_ID: TFMTBCDField;
    sqlItensVinculadosVALOR: TFMTBCDField;
    sqlItensVinculadosEMOLUMENTO_ID: TFMTBCDField;
    ...
    sqlServicoRetorno: TSimpleDataSet;
    dtsServicoRetorno: TDataSource;
    sqlServicoRetornoCAIXA_SERVICO_ID: TFMTBCDField;
    sqlServicoRetornoDESCRICAO: TStringField;
    sqlItensRetorno: TSimpleDataSet;
    dtsItensRetorno: TDataSource;
    sqlItensRetornoCAIXA_ITEM_ID: TFMTBCDField;
    sqlItensRetornoCAIXA_SERVICO_ID: TFMTBCDField;
    sqlItensRetornoUSUARIO_SERVICO_ID: TFMTBCDField;
    ...
    sqlItensRetornoVALOR_SERVICO: TFMTBCDField;
    sqlItensRetornoVALOR_PAGO: TFMTBCDField;
    ...
    sqlItensRetornoQTD: TFMTBCDField;
    cxGridDBTableView6Column3: TcxGridDBColumn;
    sqlItensRetornoCS_SERVICO_RETORNO_ID: TFMTBCDField;
    sqlItensRetornoCAIXA_SERVICO_RETORNO_ID: TFMTBCDField;
    sqlItensRetornoCAIXA_SERVICO_ENTRADA_ID: TFMTBCDField;
    ...
    sqlPesquisaOSOS_ANTIGA: TFMTBCDField;
    Panel3: TPanel;
    cxLabel4: TcxLabel;
    ...
    sqlOrdemServicoMENSALISTA_ID: TFMTBCDField;
    dxBarMensalista: TdxBarProgressItem;
    sqlCaixaItensORDEM_SERVICO_ID: TFMTBCDField;
    ClientAncestralORDEM_SERVICO_ID: TFMTBCDField;
    sqlItensVinculadosORDEM_SERVICO_ID: TFMTBCDField;
    sqlPesquisaOSORDEM_SERVICO_ID: TFMTBCDField;
    sqlItensRetornoORDEM_SERVICO_ID: TFMTBCDField;
    sqlOrdemServicoORDEM_SERVICO_ID: TFMTBCDField;
    popOS: TPopupMenu;
    ...
    sqlCaixaServicosVALOR: TFMTBCDField;
    Label9: TLabel;
    ...
    N6: TMenuItem;
    sqlCaixaItensQUITADO_CAIXA_ID: TFMTBCDField;
    ...
    sqlPesquisaOSMENSALISTA_ID: TFMTBCDField;
...
begin
  ...
  sqlPesquisaOS.DataSet.CommandText := viSql;
...
begin
  ...
  sqlItensRetorno.DataSet.ParamByName('CAIXA_SERVICO_ID').AsInteger := lcxServicoRetorno.EditValue;
...
begin
  ...
  sqlServicosSequenciais.DataSet.ParamByName('CAIXA_SERVICO_ID').AsInteger := sqlCaixaServicosCAIXA_SERVICO_ID.AsInteger;
...
begin
  ...
  sqlItensVinculados.DataSet.ParamByName('ORDEM_SERVICO_ID').AsCurrency := viOrdemServicoId;
  sqlItensVinculados.Active := True;

  sqlItensDetalhes.Active := False;
  sqlItensDetalhes.DataSet.ParamByName('ORDEM_SERVICO_ID').AsCurrency := viOrdemServicoId;
...
begin
  ...
  ClientAncestral.DataSet.ParamByName('CAIXA_ITEM_ID').AsInteger := vgCaixaDados.CaixaItemID;
...
begin
  ...
  begin
    ...
    begin
      ...
      sqlNaturezaTitulo.DataSet.ParamByName('SISTEMA_ID').AsInteger := sqlCaixaServicosSISTEMA_ID.AsInteger;
...
begin
  ...
  sqlCaixaServicos.DataSet.CommandText := Sql;
...
begin
  ...
  begin
    ...
    sqlCaixaItens.DataSet.CommandText := viSql;
...
begin
  ...
  begin
    if Application.MessageBox(Pchar('Existe Pendência Financeira em aberto pra este Mensalista!!!'+#13+#13+
