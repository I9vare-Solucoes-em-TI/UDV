object frmExportarSelo: TfrmExportarSelo
  ...
  object pnlConvenio: TPanel
    ...
    object gbxPeriodo: TcxPageControl
      ...
      Height = 78
      TabOrder = 1
      Properties.ActivePage = tbcPeriodo
      ...
      object tbcListaSelos: TcxTabSheet
        Caption = 'Lista Selos'
        ImageIndex = 2
        TabVisible = False
    ...
    object chxListaSelos: TcxCheckBox
      Left = 239
      Top = 55
      Caption = 'Pesquisar lista de selos'
      ParentFont = False
      Style.StyleController = dtmControles.cxEsc_EditsNormal
      TabOrder = 8
      OnClick = chxListaSelosClick
      Width = 133
    end
  ...
  object cxPageControl1: TcxPageControl
    ...
    Align = alClient
    TabOrder = 3
    Properties.ActivePage = tabSelosPesquisados
    Properties.CustomButtons.Buttons = <>
    Properties.Style = 6
    LookAndFeel.NativeStyle = False
    LookAndFeel.SkinName = ''
  ...
  object cdsSelos: TClientDataSet
    ...
    Top = 272
    Data = {
      110300009619E0BD02000000180000001400000000000300000011030B4E4F54
      ...
      
      004900000001000557494454480200020078000000}
    ...
    object cdsSelosCALC_SELECIONADO: TBooleanField
      FieldName = 'CALC_SELECIONADO'
    end
    ...
    object cdsSelosCALC_EXPORTADO: TBooleanField
      FieldName = 'CALC_EXPORTADO'
    end
    object cdsSelosCODIGO_EXPORTACAO: TFMTBCDField
      FieldName = 'CODIGO_EXPORTACAO'
      Precision = 20
      Size = 2
    end
    object cdsSelosVALIDADO: TBooleanField
      FieldName = 'VALIDADO'
    end
    object cdsSelosNOME_CORRIGIDO: TStringField
      FieldName = 'NOME_CORRIGIDO'
      Size = 120
    end
  end
