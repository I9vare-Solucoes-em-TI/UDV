...
uses
  ...
  FDControle, ValidarPermissaoUsuario;
...
var
  ...
  begin
    case vgId of
      1 : Result := edtSaldoRegistro.EditValue >= edtValorServico.EditValue;
      2 : Result := edtSaldoNotas.EditValue >= edtValorServico.EditValue;
    end;
  end;
    ...
    begin
      ...
      begin
        ...
        if (LiberarPermissaoUsuario('ESP_ATOCONTROLEMASTER')[6] = '0') then
            Exit;
        vgOrdemServico.AutorizacaoId   := vlUsuarioIdPermissao;
...
//  sqlOrdemServico.DataSet.ParamByName('ORDEM_SERVICO_ID').AsInteger := viOrdemServicoId;
  sqlOrdemServico.Active := True;
  vgOrdemServico.Ordem := sqlOrdemServicoORDEM_SERVICO_ID.AsInteger;

  sqlItensVinculados.Active := False;
  sqlItensVinculados.DataSet.ParamByName('ORDEM_SERVICO_ID').AsInteger := viOrdemServicoId;
