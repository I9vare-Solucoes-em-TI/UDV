...
begin
  ...
  begin
    ...
    lblReservado.Caption   := ' Reservado = '+ PegarSeloDisponivel('5');
...
begin
  ...
  if (gbxPesquisar.Visible) and (pgcPainel.ActivePageIndex = 0) then
    edtCodigo.SetFocus;
end;
...
begin
  ...
  gbxPesquisar.Visible := State = dsBrowse;
