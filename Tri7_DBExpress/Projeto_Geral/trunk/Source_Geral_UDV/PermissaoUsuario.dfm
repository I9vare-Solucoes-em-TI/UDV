object frmPermissaousuario: TfrmPermissaousuario
  Left = 265
  Top = 198
  ...
  object Panel3: TPanel
    ...
    object lcbUsuario: TcxLookupComboBox
      Left = 70
      Top = 11
      ParentFont = False
  ...
  object sqlUsuario: TSimpleDataSet
    ...
    Connection = dtmControles.DB
    DataSet.CommandText = 
      'SELECT U.* FROM G_USUARIO_SISTEMA US'#13#10'LEFT JOIN G_USUARIO U ON'#13#10 +
      '   US.USUARIO_ID = U.USUARIO_ID'#13#10'WHERE US.SISTEMA_ID = :SISTEMA_' +
      'ID AND'#13#10'               U.SITUACAO =  '#39'A'#39' '#13#10'ORDER BY U.NOME_COMPL' +
      'ETO'
    DataSet.MaxBlobSize = -1
    DataSet.Params = <
      item
    ...
    object sqlUsuarioTROCARSENHA: TStringField
    ...
    object sqlUsuarioSITUACAO: TStringField
      FieldName = 'SITUACAO'
      Size = 1
    end
    ...
    object sqlUsuarioFUNCAO: TStringField
      FieldName = 'FUNCAO'
      Size = 60
    end
    object sqlUsuarioASSINA: TStringField
      FieldName = 'ASSINA'
      Size = 1
    end
  end
  ...
  object sqlPermusuario: TSimpleDataSet
    Aggregates = <>
    Connection = dtmControles.DB
    DataSet.CommandText = 'select * from G_PERMISSAO_USUARIO'#13#10'where USUARIO_ID= :USUARIO_ID'
    DataSet.MaxBlobSize = -1
    DataSet.Params = <
      item
        DataType = ftFMTBcd
    ...
    Left = 208
    Top = 145
    object sqlPermusuarioSISTEMA_ROTINA_ID: TFMTBCDField
      FieldName = 'SISTEMA_ROTINA_ID'
      Required = True
      Precision = 15
      Size = 2
    end
    object sqlPermusuarioUSUARIO_ID: TFMTBCDField
      FieldName = 'USUARIO_ID'
      Required = True
      Precision = 15
      Size = 2
    end
    object sqlPermusuarioPERMISSAO: TStringField
      FieldName = 'PERMISSAO'
      Size = 10
    end
  end
