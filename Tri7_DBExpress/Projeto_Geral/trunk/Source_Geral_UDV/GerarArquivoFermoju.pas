...
uses
  ...
  cxNavigator, cxPCdxBarPopupMenu, cxPC, cxCheckBox, dxSkinDevExpressDarkStyle;
...
var
  ...
  vData: string;
begin
  if Application.MessageBox(Pchar('Deseja realmente gerar xml, '+#13+ 'para envio das informações do(s) selo(s) para o FERMOJU?'), 'Pergunta',
