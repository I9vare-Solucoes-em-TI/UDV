...
begin
  ...
  begin
    ...
    case vgQualificar.Tipo of
     ...
     'a' : viResultado := 'Marcação Automática';
...
begin
  ...
  begin
    ...
    if (vpValor <> '') or (LowerCase(vgQualificar.Palavra[1]) = 'd') then
         WptTextoMascara.SelectionAsString := (Qualificar_FormatarMascara(copy(vgQualificar.Palavra,3,50), LowerCase(vgQualificar.Palavra[1]), vpValor))
      ...
      'f' : begin {Outros Tipos}
              if vpMarcacao = 'MaiusculoMinusculo' then
                ...
                begin
                  ...
                  else Qualificar_FormatarMascara := FormatMaskText(copy(vpMarcacao, 14,50), vpvalor);
                end
              else
...
var
  ...
  viLista : TStringList;
  viOrdemQualificaAuxiliar : String;
