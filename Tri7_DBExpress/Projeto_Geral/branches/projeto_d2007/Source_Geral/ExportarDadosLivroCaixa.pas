...
uses
  ...
  cxCurrencyEdit, cxProgressBar, cxLookAndFeels, dxSkinBlueprint,
...
procedure TfrmExportarDadosLivroCaixa.btnPesquisarClick(Sender: TObject);
  ...
  begin
    ...
    begin
        ...
        ClientFermojuSELO_INICIAL.AsString      := dtmControles.sqlAuxiliar.FieldByName('SELO_INICIAL').AsString;
        ClientFermojuSELO_FINAL.AsString        := dtmControles.sqlAuxiliar.FieldByName('SELO_FINAL').AsString;
