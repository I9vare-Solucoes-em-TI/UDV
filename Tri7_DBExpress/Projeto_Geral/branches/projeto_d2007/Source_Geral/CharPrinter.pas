...
procedure WriteLeft (txt, fill : string; size : integer; vpAdGride : Boolean = False);
procedure WriteRight (txt, fill : string; size : integer; vpAdGride : Boolean = False);
procedure WriteCenter(txt, fill : string; size : integer; vpAdGride : Boolean = False);
procedure WriteRepeat(txt : string; quant : integer; vpPosicao : Integer; vpAdGride : Boolean = False);
...
DocInfo.pDataType := 'RAW';
  ...
  begin
    ...
    else ShowMessage('Impressora Desligada ou não localizada!!!');
  end;
...
procedure TAdvancedPrinter.WriteLeft (txt, fill : string; size : integer; vpAdGride : Boolean = False);
begin
  txt := Convert(txt);
...
procedure TAdvancedPrinter.WriteRight (txt, fill : string; size : integer; vpAdGride : Boolean = False);
begin
  txt := Convert(txt);
...
procedure TAdvancedPrinter.WriteCenter(txt, fill : string; size : integer; vpAdGride : Boolean = False);
begin
  txt := Convert(txt);
...
procedure TAdvancedPrinter.WriteRepeat(txt : string; quant : integer; vpPosicao : Integer; vpAdGride : Boolean = False);
var
  s : string;
begin
  s := '';
