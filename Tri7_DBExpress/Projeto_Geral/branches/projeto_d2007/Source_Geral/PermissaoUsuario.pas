...
uses
  ...
  cxControls, cxLookAndFeels, cxStyles, dxSkinsCore, dxSkinBlack, dxSkinCaramel,
  ...
  cxDataStorage, cxEdit, cxNavigator, cxDBData, cxImageComboBox, cxContainer,
  Menus, ImgList, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxLookupEdit,
  cxDBLookupEdit, cxGridTableView, cxClasses, cxGridCustomView, dxSkinBlue,
