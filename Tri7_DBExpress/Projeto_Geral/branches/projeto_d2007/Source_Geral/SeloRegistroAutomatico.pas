...
begin
  ...
  try
    ...
    begin
      RegistraCaixaSelo;
      frmSeloSelecionado.GravarDadosSelo('', 'T_CAIXA_REGISTROSELO', IntToStr(viRegistroSeloId), 'Registro Automático', True, DateToStr(vgSeloDataRegistroAutomatico), ClientRegistroOrdem.AsInteger);
