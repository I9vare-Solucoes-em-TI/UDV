...
uses
  ...
  FrameEditorSimples, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters,
  ...
  cxControls, cxEdit, cxStyles, dxSkinscxPCPainter, cxCustomData, cxFilter,
  ...
  Provider, SqlExpr, ComCtrls, StdCtrls, ExtCtrls;
...
uses Controles, Rotinas, Pesquisa, ControleVariaveis;
