...
uses
  ...
  cxContainer, cxEdit, cxTextEdit, Menus, cxLabel, dxSkinsCore, dxSkinBlack,
  ...
  dxSkinsDefaultPainters, dxSkinValentine, dxSkinXmas2008Blue, frxpngimage, IniFiles,
  ...
  dxSkinDevExpressDarkStyle, dxSkinMetropolis, dxSkinMetropolisDark,
