...
uses windows, messages,
  ...
  StdCtrls, ExtCtrls, ComCtrls, DBXpress, Provider,
  SqlExpr, Mask, Buttons, Variants, SimpleDS, DB, DBClient, ActnList,
  ...
  cxGridDBTableView, cxGrid, FMTBcd, cxMaskEdit, cxContainer, cxTextEdit,
  cxDropDownEdit, cxSplitter, cxGridCardView, cxLookAndFeelPainters,
  cxGridDBCardView, cxButtons,  Menus, dxSkinsCore, dxSkinsDefaultPainters,
