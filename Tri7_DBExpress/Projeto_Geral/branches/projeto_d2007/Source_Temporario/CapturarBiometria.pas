...
uses
  ...
  Dialogs, CadAuxiliar, cxLookAndFeelPainters, FMTBcd, cxContainer, cxEdit,
  cxLabel, StdCtrls, jpeg, ExtCtrls, cxPC, cxControls, DB, DBClient,
  Provider, SqlExpr, cxButtons, cxTextEdit, Menus, dxSkinsCore,
...
uses RotinasFingkey, Math, Controles;
...
begin
  ...
  if CapturarDigital('C') <> 0 then
  begin
    ShowMessage('Esta Digital já está Cadastrada para esta pessoa!!!');
    lblPrimeiraCaptuta.Caption := 'Pressione para 1ª Captura (F5)';
    lblPrimeiraCaptuta.Enabled := True;
