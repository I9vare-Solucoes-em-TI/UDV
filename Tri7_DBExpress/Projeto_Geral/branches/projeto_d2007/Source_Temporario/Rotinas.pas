...
Uses  windows, SysUtils, Types, Classes, Graphics, Controls, Forms, Dialogs,
      StdCtrls, ExtCtrls, ComCtrls, Buttons, Menus, DBTables, SqlExpr,
      Mask, ActnList, Grids, Variants, Provider, SqlEdit, Messages,
      DB, jpeg, Winsock, ZLibEx, DBGrids, Registry, NB30, WPCTRRich, Clipbrd,
      WPRTEDefs, WPCTRMemo, WPPDFR1, WPPDFWP, Printers, WinSpool, cxGridDBTableView,
      cxGraphics, math, cxTextEdit, cxCurrencyEdit, cxCalendar, Consts;
