...
uses
  ...
  dxSkinsCore, dxSkinBlack, dxSkinCaramel, dxSkiniMaginary,
  cxSplitter, StdCtrls, ExtCtrls, Menus, cxContainer, cxEdit, cxTextEdit,
  cxMaskEdit, cxDropDownEdit, cxLookupEdit, cxDBLookupEdit, cxDBLookupComboBox,
  cxButtons, DB, DBClient, SimpleDS, dxSkinBlue, dxSkinCoffee, dxSkinDarkSide,
  dxSkinGlassOceans, dxSkinLilian, dxSkinLiquidSky, dxSkinLondonLiquidSky,
  dxSkinMcSkin, dxSkinMoneyTwins, dxSkinOffice2007Black, dxSkinOffice2007Blue,
  dxSkinOffice2007Green, dxSkinOffice2007Pink, dxSkinOffice2007Silver,
  dxSkinPumpkin, dxSkinSilver, dxSkinStardust, dxSkinSummer2008,
  dxSkinsDefaultPainters, dxSkinValentine, dxSkinXmas2008Blue, WPRTEDefs,
  WPCTRMemo, WPCTRRich, cxMemo;
...
uses Controles, Rotinas, Lookup, dmChat;
