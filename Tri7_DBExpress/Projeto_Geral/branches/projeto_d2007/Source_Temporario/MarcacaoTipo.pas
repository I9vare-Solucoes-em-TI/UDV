...
uses
  ...
  FrameEditorSimples, cxMaskEdit, cxDropDownEdit, cxRadioGroup,
  cxLookupEdit, cxDBLookupEdit, cxDBLookupComboBox, FrameEditor, cxGroupBox,
  dxSkinsCore, dxSkinsDefaultPainters, SimpleDS, dxSkinBlack, dxSkinBlue,
  dxSkinCaramel, dxSkinCoffee, dxSkinDarkSide, dxSkinGlassOceans,
  dxSkiniMaginary, dxSkinLilian, dxSkinLiquidSky, dxSkinLondonLiquidSky,
  dxSkinMcSkin, dxSkinMoneyTwins, dxSkinOffice2007Black, dxSkinOffice2007Blue,
  dxSkinOffice2007Green, dxSkinOffice2007Pink, dxSkinOffice2007Silver,
  dxSkinPumpkin, dxSkinSilver, dxSkinStardust, dxSkinSummer2008,
  dxSkinValentine, dxSkinXmas2008Blue, dxSkinscxPCPainter, wpDefActions,
...
uses Controles, Principal, Rotinas, ControleVariaveis, Lookup,
...
var
  viMascara, viBookMark, viMaiusculoMinusculo : string;
  viValor : string;
begin
