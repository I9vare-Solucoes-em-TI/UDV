...
uses
  ...
  dxSkinsDefaultPainters, cxGraphics, cxDropDownEdit, cxLookupEdit,
  ...
  StdCtrls, cxButtons, ExtCtrls, cxDBEdit, dxSkinBlack, dxSkinBlue,
...
uses Controles, Rotinas, SeloLote;
...
begin
  ...
  if (viQtd > frmCadSeloLote.vgSeloDisponivel) and not vlLiberar then
  begin
