...
uses
  ...
  SimpleDS, cxPC, cxMaskEdit, cxDropDownEdit, cxLookupEdit, cxDBLookupEdit,
  cxDBLookupComboBox, cxColorComboBox, WinSpool, cxFontNameComboBox,
  FrameEditor, dxSkinsCore, dxSkinsDefaultPainters, dxSkinBlack, dxSkinBlue,
...
var
  ...
  begin
    ...
    begin
      ...
      ParamByName('TEXTO').AsBlob           := dtmControles.SimpleAuxiliar.FieldByName('TEXTO').AsString;
...
begin
  ...
  sqlConfigGrupo.Active := False;
  sqlConfigGrupo.DataSet.ParamByName('SISTEMA_ID').AsBCD := vgId;
