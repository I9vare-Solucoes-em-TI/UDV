...
type
  ...
  TfrmPrincipal = class(TForm)
    ...
    sqlLancamentoFavoritoIDENTIFICADOR_ID: TFMTBCDField;
    ...
    sqlLancamentoFavoritoIDENTIFICACAO_ID: TFMTBCDField;
