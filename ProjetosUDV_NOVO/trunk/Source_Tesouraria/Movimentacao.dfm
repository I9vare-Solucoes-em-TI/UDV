object frmMovimentacao: TfrmMovimentacao
  ...
  object sqlPesquisa1: TSimpleDataSet
    Aggregates = <>
    DataSet.CommandText = 
    ...
    object sqlPesquisa1LANCAMENTO_COMPROMISSO_ID: TFMTBCDField
      FieldName = 'LANCAMENTO_COMPROMISSO_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisa1COMPROMISSO_VENCIDO_ID: TFMTBCDField
      FieldName = 'COMPROMISSO_VENCIDO_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisa1PESSOA_ID: TFMTBCDField
      FieldName = 'PESSOA_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisa1CONTABIL_CONTA_ID: TFMTBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisa1VALOR_ATUAL: TFMTBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
    object sqlPesquisa1BOLETA_ID: TFMTBCDField
      FieldName = 'BOLETA_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlPesquisa1VALOR_ORIGEM: TFMTBCDField
      FieldName = 'VALOR_ORIGEM'
      Precision = 20
      Size = 3
    end
    object sqlPesquisa1QTD_ADICIONAL: TFMTBCDField
    ...
    object sqlPesquisa1BALANCETE_GRUPO_ID: TFMTBCDField
    ...
    object sqlPesquisa1SAIDA_NUMERO: TFMTBCDField
    ...
    object sqlPesquisa1CENTRO_CUSTO_ID: TFMTBCDField
    ...
    object sqlPesquisa1RECIBO_NUMERO: TFMTBCDField
      FieldName = 'RECIBO_NUMERO'
      Precision = 20
      Size = 2
    end
    object sqlPesquisa1SAIDA_PESSOA_ID: TFMTBCDField
  ...
  object sqlPesquisaDetalhada: TSimpleDataSet
    Aggregates = <>
    DataSet.CommandText = 
    ...
    Left = 88
    Top = 284
    object sqlPesquisaDetalhadaCONTABIL_CONTA_ID: TFMTBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisaDetalhadaCENTRO_CUSTO_ID: TFMTBCDField
      FieldName = 'CENTRO_CUSTO_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisaDetalhadaBALANCETE_GRUPO_ID: TFMTBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
    object sqlPesquisaDetalhadaVALOR_ATUAL: TFMTBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
  ...
  object sqlPesquisaPendenciaSoma: TSimpleDataSet
    Aggregates = <>
    DataSet.CommandText = 
    ...
    Left = 124
    Top = 284
    object sqlPesquisaPendenciaSomaVALOR_TOTAL: TFMTBCDField
      FieldName = 'VALOR_TOTAL'
      Precision = 20
      Size = 3
    end
  ...
  object sqlPesquisaQuitado: TSimpleDataSet
    Aggregates = <>
    DataSet.CommandText = 'SELECT  NOME'#13#10'FROM  T_PESSOA'#13#10'ORDER BY NOME'
    DataSet.MaxBlobSize = -1
    DataSet.Params = <>
    Params = <>
    Left = 160
  ...
  object ClientPesquisaDetalhada: TClientDataSet
    PersistDataPacket.Data = {
      
    ...
    Left = 216
    Top = 288
    object ClientPesquisaDetalhadaCONTABIL_CONTA_ID: TFMTBCDField
      FieldName = 'CONTABIL_CONTA_ID'
      Precision = 20
      Size = 2
    end
    object ClientPesquisaDetalhadaCENTRO_CUSTO_ID: TFMTBCDField
      FieldName = 'CENTRO_CUSTO_ID'
      Precision = 20
      Size = 2
    end
    object ClientPesquisaDetalhadaBALANCETE_GRUPO_ID: TFMTBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
    object ClientPesquisaDetalhadaVALOR_ATUAL: TFMTBCDField
      FieldName = 'VALOR_ATUAL'
      Precision = 20
      Size = 3
    end
