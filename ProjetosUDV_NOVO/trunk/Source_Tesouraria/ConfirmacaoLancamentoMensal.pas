unit ConfirmacaoLancamentoMensal;
...
type
  ...
  TDadosConfimacao = Record
    Data: TDateTime;
    Qtd, CaixaId : Integer;
    Confirmado, GerarBoleto, Detalhar, ReciboEmail : Boolean;
    Saida : Boolean;
    Especie, Observacao, NumeroRecibo : String;
  End;
...
begin
  ...
  vgDadosConfirmacao.Especie    := icxEspecie.EditValue;
  vgDadosConfirmacao.Observacao := '';
  vgDadosConfirmacao.ReciboEmail:= chxReciboEmail.Checked;
  close;
end;
