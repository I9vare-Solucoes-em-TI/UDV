...
type
  TfrmControleBalancete = class(TForm)
    ...
    cxLabel14: TcxLabel;
    cxLabel13: TcxLabel;
    sqlBalanceteAnterior: TSimpleDataSet;
    dtsBalanceteAnterior: TDataSource;
    sqlBalanceteAnteriorBALANCETE_ID: TFMTBCDField;
    sqlBalanceteAnteriorREFERENCIA: TStringField;
    sqlBalanceteAnteriorSALDO_CONTA: TFMTBCDField;
    sqlBalanceteAnteriorSALDO_APLICACAO: TFMTBCDField;
    sqlBalanceteAnteriorSALDO_CAIXA: TFMTBCDField;
    sqlBalanceteAnteriorSALDO_NAO_COMPENSADO: TFMTBCDField;
    ...
    sqlBalanceteAtual: TSimpleDataSet;
    dtsBalanceteAtual: TDataSource;
    sqlBalanceteAtualBALANCETE_ID: TFMTBCDField;
    sqlBalanceteAtualREFERENCIA: TStringField;
    sqlBalanceteAtualSALDO_CONTA: TFMTBCDField;
    sqlBalanceteAtualSALDO_APLICACAO: TFMTBCDField;
    sqlBalanceteAtualSALDO_CAIXA: TFMTBCDField;
    sqlBalanceteAtualSALDO_NAO_COMPENSADO: TFMTBCDField;
    ...
    sqlBalanceteHistorico: TSimpleDataSet;
    sqlBalanceteHistoricoBALANCETE_HISTORICO_ID: TFMTBCDField;
    sqlBalanceteHistoricoBALANCETE_ID: TFMTBCDField;
    sqlBalanceteHistoricoBALANCETE_GRUPO_ID: TFMTBCDField;
    sqlBalanceteHistoricoENTRADAS: TFMTBCDField;
    sqlBalanceteHistoricoSAIDAS: TFMTBCDField;
    sqlBalanceteAtualCEDENTE_ID: TFMTBCDField;
    sqlBalanceteAnteriorCEDENTE_ID: TFMTBCDField;
    frxDBDataSetBalanceteLeitura: TfrxDBDataset;
    frxReport1: TfrxReport;
    sqDadosBalanceteLeitura: TSimpleDataSet;
    dtsBalanceteLeitura: TDataSource;
    sqDadosBalanceteLeituraVALOR: TFMTBCDField;
    ...
    sqlBalanceteHistoricoSALDO_FINAL: TFMTBCDField;
    sqlBalanceteHistoricoSALDO_ANTERIOR: TFMTBCDField;
    ...
    sqlDadosGenericos: TSimpleDataSet;
    dtsDadosGenericos: TDataSource;
    frxDBDataSetDadosGenericos: TfrxDBDataset;
    sqlDadosGenericosVALOR_ATUAL: TFMTBCDField;
    ...
    sqDadosBalanceteContador: TSimpleDataSet;
    dtsBalanceteContador: TDataSource;
    sqDadosBalanceteContadorVALOR: TFMTBCDField;
    ...
    sqlBalanceteDetalhado: TSimpleDataSet;
    dtsBalanceteDetalhado: TDataSource;
    sqlBalanceteDetalhadoDATA_REALIZACAO: TSQLTimeStampField;
    sqlBalanceteDetalhadoVALOR_ATUAL: TFMTBCDField;
    sqlBalanceteDetalhadoTIPO_OPERACAO: TStringField;
    sqlBalanceteDetalhadoRECIBO_NUMERO: TFMTBCDField;
    sqlBalanceteDetalhadoBOLETA_ID: TFMTBCDField;
    sqlBalanceteDetalhadoSAIDA_NUMERO: TFMTBCDField;
    ...
    sqlDadosBalanceteAnual: TSimpleDataSet;
    ...
    sqlDadosBalanceteGeral: TSimpleDataSet;
    dtsBalanceteGeral: TDataSource;
    sqlDadosBalanceteGeralVALOR: TFMTBCDField;
    ...
    sqlDadosBalanceteGeralBALANCETE_GRUPO_ID: TFMTBCDField;
...
begin
  ...
  sqlDadosBalanceteAnual.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
  sqlDadosBalanceteAnual.DataSet.ParamByName('BALANCETE_GRUPO_ID').AsInteger := ClientBalancetesBALANCETE_GRUPO_ID.AsInteger;
...
begin
   ...
   try
     ...
     begin
       ...
       sqlBalanceteHistorico.ApplyUpdates(-1);
       ClientBalancetes.Next;
     end;

     sqlBalanceteAtual.Edit;
     sqlBalanceteAtualSITUACAO.AsString := '2';
     sqlBalanceteAtual.ApplyUpdates(-1);
...
begin
  ...
  sqlBalanceteAnterior.CancelUpdates;
  sqlBalanceteHistorico.CancelUpdates;  
end;

procedure TfrmControleBalancete.btnCancelarAtualClick(Sender: TObject);
begin
  HabilitarCamposSaldoAtual(False);
  sqlBalanceteAtual.CancelUpdates;
end;
...
begin
  ...
  HabilitarCamposSaldoAnterior(False);
  sqlBalanceteAnterior.ApplyUpdates(-1);
  sqlBalanceteHistorico.ApplyUpdates(-1);
...
begin
  ...
  sqDadosBalanceteLeitura.DataSet.ParamByName('ANO_MES_REALIZADO').AsString   := vlReferencia;
  sqDadosBalanceteLeitura.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
  sqDadosBalanceteLeitura.DataSet.ParamByName('BALANCETE_GRUPO_ID').AsInteger := ClientBalancetesBALANCETE_GRUPO_ID.AsInteger;
  sqDadosBalanceteLeitura.Active := True;

  sqlDadosGenericos.Active := False;
  sqlDadosGenericos.DataSet.ParamByName('ANO_MES_REALIZADO').AsString   := vlReferencia;
  sqlDadosGenericos.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
  sqlDadosGenericos.DataSet.ParamByName('BALANCETE_GRUPO_ID').AsInteger := ClientBalancetesBALANCETE_GRUPO_ID.AsInteger;
...
var
  ...
  begin
    ...
    sqlBalanceteAtual.DataSet.ParamByName('BALANCETE_ID').AsInteger := 0;
...
begin
  ...
  sqlBalanceteAtual.Active := False;
  sqlBalanceteAtual.DataSet.ParamByName('BALANCETE_ID').AsInteger := viBalanceteAtual;
  sqlBalanceteAtual.Active := True;
...
begin
  ...
  sqlBalanceteAnterior.DataSet.ParamByName('BALANCETE_ID').AsInteger := vlBalanceteAnteriorId;
...
begin
  ...
  sqlDadosBalanceteGeral.DataSet.ParamByName('ANO_MES_REALIZADO').AsString   := vlReferencia;
  sqlDadosBalanceteGeral.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
...
begin
  ...
  sqDadosBalanceteContador.DataSet.ParamByName('ANO_MES_REALIZADO').AsString   := vlReferencia;
  sqDadosBalanceteContador.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
  sqDadosBalanceteContador.DataSet.ParamByName('BALANCETE_GRUPO_ID').AsInteger := ClientBalancetesBALANCETE_GRUPO_ID.AsInteger;
...
begin
  ...
  sqlBalanceteDetalhado.DataSet.ParamByName('ANO_MES_REALIZADO').AsString   := vlReferencia;
  sqlBalanceteDetalhado.DataSet.ParamByName('CEDENTE_ID').AsInteger         := vgCedenteAtivo;
  sqlBalanceteDetalhado.DataSet.ParamByName('BALANCETE_GRUPO_ID').AsInteger := ClientBalancetesBALANCETE_GRUPO_ID.AsInteger;
...
begin
  sqlBalanceteAnterior.Active := False;
  sqlBalanceteAnterior.DataSet.ParamByName('BALANCETE_ID').AsInteger := 0;
  sqlBalanceteAnterior.Active := True;
...
begin
  ...
  sqlBalanceteHistorico.DataSet.ParamByName('BALANCETE_ID').AsBCD := sqlBalanceteAnteriorBALANCETE_ID.AsInteger;
  sqlBalanceteHistorico.Active := True;
end;
