...
type
  TfrmCadOrcamentoCadastro = class(TfrmCadBasico)
    ...
    cxLabel1: TcxLabel;
    ClientAncestralORCAMENTO_RESERVA_ID: TFMTBCDField;
    ClientAncestralDESCRICAO: TFMTBCDField;
...
begin
  ...
  begin
    Application.MessageBox('Não existe nenhum cedente cadastrado ou ativo!', 'Atenção', MB_OK + MB_ICONWARNING);
    exit;
  end;
...
begin
  inherited;
  vgNomeTabela    := 'T_ORCAMENTO_RESERVA';
  vgChavePrimaria := 'ORCAMENTO_RESERVA_ID';
