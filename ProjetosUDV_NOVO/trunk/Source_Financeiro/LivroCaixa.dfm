object frmLivroCaixa: TfrmLivroCaixa
  ...
  object sqlLivroCaixa: TSimpleDataSet
    ...
    FieldDefs = <
      ...
      item
        Name = 'CONTADOR_CONTABILIZAR'
        DataType = ftString
        Size = 1
      end
      item
        Name = 'DESCRICAO_AGRUPADOR'
        DataType = ftString
        Size = 120
      end
      item
      ...
      item
        Name = 'CONTABIL_CONTA_DESCRICAO'
        DataType = ftString
        Size = 90
      end
      item
        Name = 'GRUPO_SECUDARIO'
        DataType = ftString
        Size = 60
      end
      item
    ...
    object sqlLivroCaixaASSOCIADO_ID: TFMTBCDField
      FieldName = 'ASSOCIADO_ID'
      Precision = 20
      Size = 2
    end
    object sqlLivroCaixaCOMPROMISSO_VENCIDO_ID: TFMTBCDField
    ...
    object sqlLivroCaixaRESERVA_ID: TFMTBCDField
    ...
    object sqlLivroCaixaTIPO_DESPESA_ID: TFMTBCDField
      FieldName = 'TIPO_DESPESA_ID'
      Precision = 20
      Size = 2
    end
    object sqlLivroCaixaIDENTIFICACAO_ID: TFMTBCDField
  ...
  object sqlRecibo: TSimpleDataSet
    ...
    object sqlReciboIDENTIFICACAO_ID: TFMTBCDField
      FieldName = 'IDENTIFICACAO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlCaixaSimplificado: TSimpleDataSet
    Aggregates = <>
    DataSet.CommandText = 
    ...
    Left = 280
    Top = 438
    object sqlCaixaSimplificadoCAIXA_ID: TFMTBCDField
      FieldName = 'CAIXA_ID'
      Precision = 20
      Size = 2
    end
    ...
    object sqlCaixaSimplificadoVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
    ...
    object sqlCaixaSimplificadoORDEM: TFMTBCDField
      FieldName = 'ORDEM'
      Precision = 20
      Size = 2
    end
    ...
    object sqlCaixaSimplificadoCAIXA_TRANSFERENCIA_ID: TFMTBCDField
      FieldName = 'CAIXA_TRANSFERENCIA_ID'
      Precision = 20
      Size = 2
    end
    object sqlCaixaSimplificadoIDENTIFICACAO_ID: TFMTBCDField
      FieldName = 'IDENTIFICACAO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlTransfProvisao: TSimpleDataSet
    Aggregates = <>
    ...
    Left = 95
    Top = 462
    object sqlTransfProvisaoLIVRO_CAIXA_ID: TFMTBCDField
      FieldName = 'LIVRO_CAIXA_ID'
      Required = True
      Precision = 20
      Size = 2
    ...
    object sqlTransfProvisaoRESERVA_ID: TFMTBCDField
      FieldName = 'RESERVA_ID'
      Precision = 20
      Size = 2
    end
    object sqlTransfProvisaoVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Precision = 20
      Size = 3
    end
