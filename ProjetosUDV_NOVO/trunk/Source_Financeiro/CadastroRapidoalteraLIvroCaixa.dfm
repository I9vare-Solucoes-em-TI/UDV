inherited frmCadastroRapidoAlteraLivroCaixa: TfrmCadastroRapidoAlteraLivroCaixa
  ...
  inherited ClientAncestral: TClientDataSet
    Left = 519
    Top = 221
    object ClientAncestralLIVRO_CAIXA_ID: TFMTBCDField
  ...
  object sqlPlanoContas: TSimpleDataSet
    ...
    DataSet.CommandText = 
      'SELECT CC.CONTABIL_CONTA_ID, CC.DESCRICAO, CC.IR, CC.CNJ'#13#10'FROM T' +
      '_CONTABIL_CONTA CC LEFT OUTER JOIN T_CONTABIL_GRUPO CG ON'#13#10'  CC.' +
