object dtmLookupContabil: TdtmLookupContabil
  ...
  object sqlTipoDespesaTodos: TSimpleDataSet
    Aggregates = <>
    Connection = dtmControles.DB
    DataSet.CommandText = 
    ...
    object sqlTipoDespesaTodosTIPO_DESPESA_ID: TFMTBCDField
  ...
  object sqlTipoDespesaAtivos: TSimpleDataSet
    Aggregates = <>
    Connection = dtmControles.DB
    DataSet.CommandText = 
  ...
  object sqlBalanceteAtivos: TSimpleDataSet
    Aggregates = <>
    Connection = dtmControles.DB
    DataSet.CommandText = 
    ...
    object sqlBalanceteAtivosBALANCETE_GRUPO_ID: TFMTBCDField
      FieldName = 'BALANCETE_GRUPO_ID'
      Precision = 20
      Size = 2
    end
  ...
  object sqlCompromissoReserva: TSimpleDataSet
    Aggregates = <>
    Connection = dtmControles.DB
    DataSet.CommandText = 
